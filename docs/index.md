...
| [`runbooks/restore-do-backup.md`](runbooks/restore-do-backup.md) | **Restaurar o banco do backup** — passo a passo do `restore.sh`, verificação pós-restore, limitações honestas e o estado do drill |
