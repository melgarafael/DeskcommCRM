...
- **Onde:** worktree `/Users/rafaelmelgaco/SonghaiCRM/.claude/worktrees/webhooks`, branch `feat/webhooks-automation` (base origin/main). Checkout principal está no `gov/G4` com trabalho do gov-loop — NÃO tocar nele.
