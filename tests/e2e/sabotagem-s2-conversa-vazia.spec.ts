/**
 * ⚠️ ARQUIVO DESCARTÁVEL — SABOTAGEM DO #1325, ramo `descartavel/1318-sabotagem`.
 * NÃO existe na `main` nem no head do PR. Cópia do arquivo real com UMA linha de
 * semeadura removida, para medir o que o verde do PR não prova: que estes casos
 * ficam VERMELHOS quando o dado não está lá.
 * S2: a conversa é criada SEM mensagem.
 */
...
async function conversaComMensagem(nome: string, texto: string): Promise<string> {
  ...
  // SABOTAGEM S2: a conversa e o contato são criados, a MENSAGEM não. A conversa
  // abre vazia — é este o caso que só a asserção de bolha pode pegar.
  void texto;
...
test.describe("SABOTAGEM S2 (conversa vazia) — responder citando", () => {
