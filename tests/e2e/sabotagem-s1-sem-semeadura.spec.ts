 ...
 * S1: o `beforeAll` NÃO semeia nada.
 */
...
test.beforeAll(async () => {
  ...
  // SABOTAGEM S1: as DUAS chamadas de semeadura saíram. `conversas` fica vazio.
...
test.describe("SABOTAGEM S1 (sem semeadura) — responder citando", () => {
