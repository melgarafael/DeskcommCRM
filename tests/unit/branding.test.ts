...
const HOSTS_DECLARADOS: Record<string, EntradaDeHost> = {
  ...
  "cdninstagram.com": {
    categoria: "FORNECEDOR",
    motivo:
      "CDN de mídia do Instagram aceito pelo adapter social para baixar anexos recebidos. O host é validado antes da resolução de rede e não é texto de marca.",
  },
  "fbcdn.net": {
    categoria: "FORNECEDOR",
    motivo:
      "CDN de mídia da Meta aceito pelo adapter social para baixar anexos recebidos. O host é validado antes da resolução de rede.",
  },
  "proxy.webshare.io": {
    categoria: "FORNECEDOR",
    motivo:
      "endpoint padrão do fornecedor de proxy usado quando a instalação opta pelo pool anti-ban; credenciais e ativação continuam sendo configuração da instalação.",
  },
  "hub.sociosai.com": {
    categoria: "FORNECEDOR",
    motivo:
      "endpoint do provedor intermediado que conecta e transporta DMs de Instagram e Messenger para cada subconta da organização.",
  },
  "www.googleapis.com": {
    categoria: "FORNECEDOR",
    motivo:
