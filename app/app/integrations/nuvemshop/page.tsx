...
export default async function NuvemshopIntegrationPage() {
  ...
  return (
    /*
      Superficie clara. Aqui o `-m-6` e o `bg-bg` moram num wrapper EXTERNO, e
      nao no proprio cartao: este e `mx-auto max-w-3xl`, ou seja, uma coluna
      centrada e estreita. Pintar o Paper nele deixaria duas faixas escuras nas
      laterais em telas largas — o fundo tem de ser da area toda, e a largura
      maxima segue valendo so para o conteudo.
    */
    <div
