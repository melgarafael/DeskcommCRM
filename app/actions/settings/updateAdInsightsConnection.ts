 ...
 * conversões, e separada dela pelas razões no cabeçalho da migration 0205 (a
 * decisiva: o índice único da 0204 é `(organization_id, platform)` e os dois
...
const entradaSchema = z.object({
   ...
   * "apague" — mesma regra da 0204, pelo mesmo motivo (um salvamento distraído
...
export async function updateAdInsightsConnection(
  ...
  // coluna é NOT NULL (0205) e o banco recusaria de qualquer jeito, mas com uma
  ...
  // O `onConflict` é o índice único `(organization_id, platform)` da 0205.
