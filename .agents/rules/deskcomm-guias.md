...
Este repositório embute guias (skills em `.agents/skills/`) para sete situações. Quando o pedido
...
- antes de começar qualquer implementação ou melhoria nova, mesmo que pareça pequena → `deskcomm-especialista`
  (mapeia doutrina, padrões de UI/UX e de criação de agentes de IA, e decide quais outras
  skills carregar)
