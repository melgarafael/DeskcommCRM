...
export const INSTAGRAM_ES: Record<string, { es: string }> = {
  ...
  "Uma ideia já é um começo. Descreva do seu jeito; a imagem nasce daqui.": {
    es: "Una idea ya es un comienzo. Descríbela a tu manera; la imagen nace aquí.",
  },
  "Qual é o seu negócio?": { es: "¿Cuál es tu negocio?" },
  "Ex.: confeitaria artesanal": { es: "Ej.: repostería artesanal" },
  "Conte sua ideia": { es: "Cuéntanos tu idea" },
  "Quero mostrar meu bolo de chocolate e convidar as pessoas para encomendar no fim de semana. Cores quentes, estilo artesanal…":
    {
      es: "Quiero mostrar mi pastel de chocolate e invitar a hacer pedidos para el fin de semana. Colores cálidos, estilo artesanal…",
    },
  ...
  "A imagem pode levar alguns minutos. Seu pedido já fica na biblioteca. Você não precisa enviar novamente.":
    {
      es: "La imagen puede tardar unos minutos. Tu pedido queda en la biblioteca. No necesitas enviarlo de nuevo.",
    },
  "GPT Image 2.5 · A imagem fica salva para você revisar e baixar. Nada é publicado automaticamente.":
    {
      es: "GPT Image 2.5 · La imagen se guarda para revisar y descargar. Nada se publica automáticamente.",
    },
  ...
  "Da sua ideia para o mundo": { es: "De tu idea al mundo" },
  "Seu negócio tem muito para contar.": { es: "Tu negocio tiene mucho que contar." },
  "Transforme uma ideia em uma postagem com a sua cara. Escreve aí.": {
    es: "Convierte una idea en una publicación con tu estilo. Escribe aquí.",
  },
  "Criar minha postagem": { es: "Crear mi publicación" },
  "Você descreve. A IA desenha. Você revisa.": { es: "Tú describes. La IA diseña. Tú revisas." },
  "Uma ideia.": { es: "Una idea." },
  "Seu jeito.": { es: "Tu estilo." },
  "crie · revise · compartilhe": { es: "crea · revisa · comparte" },
  "Sem ideia do que postar? ↗": { es: "¿Sin ideas para publicar? ↗" },
  "Explore referências e encontre um assunto para o seu nicho.": {
    es: "Explora referencias y encuentra un tema para tu sector.",
  },
  "Entenda o que funcionou ↗": { es: "Entiende qué funcionó ↗" },
  "Veja o alcance e as interações da sua conta conectada.": {
    es: "Consulta el alcance y las interacciones de tu cuenta conectada.",
  },
  "Tentar novamente": { es: "Intentar de nuevo" },
  "Suas últimas ideias": { es: "Tus últimas ideas" },
  "Ver todas": { es: "Ver todas" },
  "Sua primeira criação vai aparecer aqui.": { es: "Tu primera creación aparecerá aquí." },
  "Você pode acompanhar as criações da sua equipe. Para criar, peça acesso de edição.": {
    es: "Puedes ver las creaciones de tu equipo. Para crear, solicita acceso de edición.",
  },
  ...
  "A conta não disponibilizou essa métrica neste período.": {
    es: "La cuenta no proporcionó esta métrica para el período.",
  },
  ...
  "Uma boa referência vira uma ideia sua.": {
    es: "Una buena referencia se convierte en una idea propia.",
  },
  "Explore assuntos do seu nicho e perfis que você admira. A pesquisa procura fontes públicas; adicionar um perfil não segue nem envia mensagens a ele.":
    {
      es: "Explora temas de tu sector y perfiles que admiras. La búsqueda consulta fuentes públicas; añadir un perfil no lo sigue ni le envía mensajes.",
    },
  "Qual é o seu nicho?": { es: "¿Cuál es tu sector?" },
  "Ex.: estética, imobiliária, confeitaria…": { es: "Ej.: estética, inmobiliaria, repostería…" },
  ...
  "Ex.: ideias recentes para mostrar bastidores e atrair encomendas": {
    es: "Ej.: ideas recientes para mostrar el trabajo y atraer pedidos",
  },
  "Preparando…": { es: "Preparando…" },
  "Buscar inspirações": { es: "Buscar inspiraciones" },
  "As sugestões mostram as fontes. Popularidade só é afirmada quando houver evidência.": {
    es: "Las sugerencias muestran las fuentes. Solo se afirma popularidad cuando hay evidencia.",
  },
  ...
  "Pesquisado em": { es: "Consultado el" },
  ...
  "As imagens que você criar ficam aqui, junto com seus pedidos e legendas.": {
    es: "Las imágenes que crees quedan aquí, junto con tus pedidos y textos.",
  },
  "Revisar postagem": { es: "Revisar publicación" },
  "Agora, deixe com a sua cara.": { es: "Ahora, dale tu estilo." },
  ...
  "Escreva o convite para quem vai ver sua postagem…": {
    es: "Escribe la invitación para quien verá tu publicación…",
  },
  ...
  "Pedido preservado": { es: "Pedido conservado" },
  ...
  "Conquiste novos clientes": { es: "Consigue nuevos clientes" },
  "Seu Instagram": { es: "Tu Instagram" },
  "Minhas criações": { es: "Mis creaciones" },
  "Post vertical": { es: "Publicación vertical" },
  "Post quadrado": { es: "Publicación cuadrada" },
  Story: { es: "Historia" },
  "Pessoas alcançadas": { es: "Personas alcanzadas" },
  Visualizações: { es: "Visualizaciones" },
  "Pessoas que interagiram": { es: "Personas que interactuaron" },
  Interações: { es: "Interacciones" },
  "Quantas contas viram seu conteúdo.": { es: "Cuántas cuentas vieron tu contenido." },
  "Quantas vezes seu conteúdo foi visto.": { es: "Cuántas veces se vio tu contenido." },
  "Contas que tiveram alguma interação.": { es: "Cuentas que tuvieron alguna interacción." },
  "Ações registradas no seu conteúdo.": { es: "Acciones registradas en tu contenido." },
};
