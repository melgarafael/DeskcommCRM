...
export const DICIONARIO: Traducoes = {
  ...INSTAGRAM_ES,
  "Ative as chamadas para conectar seu número.": {
    es: "Activa las llamadas para conectar tu número.",
  },
  "Um administrador precisa ativar as chamadas em Segurança e confirmar o aviso sobre o risco de bloqueio do WhatsApp. Depois, volte aqui para conectar o aparelho pelo QR Code.":
    {
      es: "Un administrador debe activar las llamadas en Seguridad y confirmar el aviso sobre el riesgo de bloqueo de WhatsApp. Después, vuelve aquí para conectar el dispositivo con el código QR.",
    },
  "Abrir configuração de chamadas": { es: "Abrir configuración de llamadas" },
  "Informe o custo em dólares, a referência da consulta e confirme a verificação.": {
    es: "Indica el costo en dólares, la referencia de la consulta y confirma la verificación.",
  },
  "Conciliação confirmada. Valor aplicado à franquia:": {
    es: "Conciliación confirmada. Importe aplicado al saldo incluido:",
  },
  "Não foi possível confirmar. Os dados foram preservados. Atualize a lista antes de tentar novamente.":
    {
      es: "No se pudo confirmar. Los datos se conservaron. Actualiza la lista antes de volver a intentarlo.",
    },
  "Consumos em conferência": { es: "Consumos en revisión" },
  "Confira o custo no provedor antes de liberar a reserva. Esta ação não gera cobrança extra.": {
    es: "Verifica el costo con el proveedor antes de liberar la reserva. Esta acción no genera un cobro adicional.",
  },
  "Atualizar lista": { es: "Actualizar lista" },
  "Ver auditoria": { es: "Ver auditoría" },
  "Carregando consumos…": { es: "Cargando consumos…" },
  "Não foi possível carregar os consumos. Tente atualizar a lista.": {
    es: "No se pudieron cargar los consumos. Intenta actualizar la lista.",
  },
  "Nenhum consumo em conferência nesta página.": {
    es: "No hay consumos en revisión en esta página.",
  },
  "Provedor não identificado": { es: "Proveedor no identificado" },
  "Modelo não identificado": { es: "Modelo no identificado" },
  "Reserva:": { es: "Reserva:" },
  "Conferir consumo": { es: "Revisar consumo" },
  "Ver referências da chamada": { es: "Ver referencias de la llamada" },
  "Referência não retornada": { es: "Referencia no devuelta" },
  "Entrada:": { es: "Entrada:" },
  "Saída:": { es: "Salida:" },
  "O provedor não retornou evidência completa. Não estime o custo pelos horários ou pelo texto da resposta.":
    {
      es: "El proveedor no devolvió evidencia completa. No estimes el costo a partir de los horarios o del texto de la respuesta.",
    },
  "Primeira página": { es: "Primera página" },
  "Próximos consumos": { es: "Siguientes consumos" },
  "Confirmar custo apurado": { es: "Confirmar costo verificado" },
  "Some todas as etapas desta execução conforme a consulta ao provedor. Use zero somente se a ausência de custo foi comprovada.":
    {
      es: "Suma todas las etapas de esta ejecución según la consulta al proveedor. Usa cero solo si se comprobó que no hubo costo.",
    },
  "Custo confirmado no provedor (US$)": { es: "Costo confirmado con el proveedor (US$)" },
  "Tarifa do ciclo:": { es: "Tarifa del ciclo:" },
  "por US$ 1. O desconto respeita o saldo disponível do ciclo original.": {
    es: "por US$ 1. El descuento respeta el saldo disponible del ciclo original.",
  },
  "Referência da verificação no provedor": { es: "Referencia de la verificación con el proveedor" },
  "Identifique o relatório ou consulta e as chamadas verificadas. Não inclua chaves, mensagens ou dados de clientes.":
    {
      es: "Identifica el informe o consulta y las llamadas verificadas. No incluyas claves, mensajes ni datos de clientes.",
    },
  "Conferi todas as chamadas desta execução no provedor e confirmo o valor informado.": {
    es: "Revisé todas las llamadas de esta ejecución con el proveedor y confirmo el importe indicado.",
  },
  "Confirmar conciliação": { es: "Confirmar conciliación" },
  "Custo AI / dia (US$)": { es: "Costo IA / día (US$)" },
  "A equipe atingiu o limite do plano ou tem uma pendência na assinatura. Peça ao administrador para conferir Planos e assinatura e tente aceitar novamente.":
    {
      es: "El equipo alcanzó el límite del plan o tiene un problema con la suscripción. Pide al administrador que revise Planes y suscripción e intenta aceptar de nuevo.",
    },
  "Sua franquia de IA": { es: "Tu saldo de IA" },
  "Ciclo:": { es: "Ciclo:" },
  "O saldo aparecerá após a confirmação do ciclo da assinatura.": {
    es: "El saldo aparecerá tras la confirmación del ciclo de la suscripción.",
  },
  ...
  "O uso de IA está pausado enquanto conferimos um consumo anterior. Seu saldo foi preservado.": {
    es: "El uso de IA está pausado mientras revisamos un consumo anterior. Tu saldo se ha conservado.",
  },
  "Este saldo não está liberado para uso. Confira a situação da sua assinatura.": {
    es: "Este saldo no está disponible para su uso. Revisa el estado de tu suscripción.",
  },
  "O saldo está usado ou reservado por atendimentos em andamento. Não haverá cobrança automática de excedente.":
    {
      es: "El saldo está utilizado o reservado por atenciones en curso. No habrá cobros automáticos por excedentes.",
    },
  "Enquanto a IA atende, parte do saldo fica reservada. Ao concluir, descontamos o consumo e liberamos a diferença.":
    {
      es: "Mientras la IA atiende, parte del saldo queda reservada. Al finalizar, descontamos el consumo y liberamos la diferencia.",
    },
  "Tarifa fixa deste ciclo:": { es: "Tarifa fija de este ciclo:" },
  "por US$ 1 de consumo de IA. Sem cobrança automática de excedente.": {
    es: "por US$ 1 de consumo de IA. Sin cobros automáticos por excedentes.",
  },
  "Não foi possível consultar o saldo de IA. Atualize a página para tentar novamente.": {
    es: "No se pudo consultar el saldo de IA. Actualiza la página para intentarlo de nuevo.",
  },
  "Não foi possível adicionar este recurso ao plano atual. Peça ao administrador para conferir os limites e o pagamento em Configurações → Planos e assinatura. Seus recursos existentes foram preservados.":
    {
      es: "No se pudo añadir este recurso al plan actual. Pide al administrador que revise los límites y el pago en Configuración → Planes y suscripción. Tus recursos existentes se han conservado.",
    },
  ...
  "Sua assinatura precisa de atenção. Abra a gestão para conferir o pagamento.": {
    es: "Tu suscripción necesita atención. Abre la gestión para revisar el pago.",
  },
  "Sua assinatura foi encerrada. Seus recursos existentes foram preservados.": {
    es: "Tu suscripción finalizó. Tus recursos existentes se han conservado.",
  },
  "O pagamento ainda não foi confirmado. Você pode continuar com o plano escolhido.": {
    es: "El pago aún no se ha confirmado. Puedes continuar con el plan elegido.",
  },
  ...
  "O estado é atualizado após a confirmação do provedor. Voltar do pagamento não confirma a assinatura.":
    {
      es: "El estado se actualiza tras la confirmación del proveedor. Volver del pago no confirma la suscripción.",
    },
  ...
  "Consulte sua assinatura antes de escolher outro plano.": {
    es: "Consulta tu suscripción antes de elegir otro plan.",
  },
  ...
  "Já existe uma assinatura ou pagamento em andamento. Atualize a página para conferir.": {
    es: "Ya existe una suscripción o un pago en curso. Actualiza la página para revisarlo.",
  },
  "Não foi possível abrir o pagamento. Tente novamente.": {
    es: "No se pudo abrir el pago. Inténtalo de nuevo.",
  },

  "Abrindo gestão da assinatura...": { es: "Abriendo gestión de la suscripción..." },
  "Gerenciar assinatura": { es: "Gestionar suscripción" },
  "Consulte faturas, atualize o pagamento ou cancele sua assinatura.": {
    es: "Consulta facturas, actualiza el pago o cancela tu suscripción.",
  },
  "Não foi possível abrir a gestão da assinatura. Tente novamente.": {
    es: "No se pudo abrir la gestión de la suscripción. Inténtalo de nuevo.",
  },
  "Não foi possível consultar sua assinatura. Atualize a página para tentar novamente.": {
    es: "No se pudo consultar tu suscripción. Actualiza la página para intentarlo de nuevo.",
  },
  ...
  Crescer: { es: "Crecer" },
  Escala: { es: "Escala" },
  "Para começar a atender com organização e IA.": {
    es: "Para empezar a atender con organización e IA.",
  },
  "Para unir a equipe, os canais e as oportunidades.": {
    es: "Para unir al equipo, los canales y las oportunidades.",
  },
  "Para uma operação maior, com mais pessoas e agentes.": {
    es: "Para una operación mayor, con más personas y agentes.",
  },
  "Mensalidade em reais. A franquia de IA é compartilhada pelos agentes da empresa e varia conforme o modelo e o volume de texto. Não representa uma quantidade garantida de mensagens.":
    {
      es: "Mensualidad en reales. El crédito de IA se comparte entre los agentes de la empresa y varía según el modelo y el volumen de texto. No representa una cantidad garantizada de mensajes.",
    },
  "Tarifas cobradas pela Meta e por outros provedores de canal são separadas. A conexão do Instagram depende das permissões e da aprovação da Meta.":
    {
      es: "Las tarifas de Meta y de otros proveedores de canales se cobran por separado. La conexión de Instagram depende de los permisos y de la aprobación de Meta.",
    },
  "Estes são os novos planos. Sua conta e seus acessos atuais permanecem como estão até a contratação ser concluída.":
    {
      es: "Estos son los nuevos planes. Tu cuenta y tus accesos actuales se mantienen hasta que se complete la contratación.",
    },

  "O que você quer que ele faça?": { es: "¿Qué quieres que haga?" },
  "Escolha as tarefas. Você pode ajustar os detalhes depois.": {
    es: "Elige las tareas. Puedes ajustar los detalles después.",
  },
  "Modo de configuração": { es: "Modo de configuración" },
  Simples: { es: "Simple" },
  Avançado: { es: "Avanzado" },
  "Buscar uma capacidade": { es: "Buscar una capacidad" },
  "Escolher outro canal": { es: "Elegir otro canal" },
  "Prepare a conexão da sua empresa": { es: "Prepara la conexión de tu empresa" },
  "A integração precisa ser preparada pela equipe responsável. Depois, você autoriza sua conta na própria rede e escolhe onde receber as mensagens.":
    {
      es: "El equipo responsable debe preparar la integración. Después, autorizas tu cuenta en la propia red y eliges dónde recibir los mensajes.",
    },
  "Configuração da integração": { es: "Configuración de la integración" },
  "Comportamento e repasses": { es: "Comportamiento y transferencias" },
  "Permissões com efeitos no atendimento": { es: "Permisos con efectos en la atención" },
  "A IA gerenciada já está disponível. Adicione uma chave própria somente se quiser usar outra conta; agentes existentes mantêm suas configurações.":
    {
      es: "La IA gestionada ya está disponible. Añade una clave propia solo si deseas usar otra cuenta; los agentes existentes mantienen sus configuraciones.",
    },
  "Veja quem alterou os dados da empresa, o que mudou e quando.": {
    es: "Consulta quién modificó los datos de la empresa, qué cambió y cuándo.",
  },
  "Convide sua equipe, defina o acesso de cada pessoa e organize o atendimento.": {
    es: "Invita a tu equipo, define el acceso de cada persona y organiza la atención.",
  },
  "Mantenha os dados da empresa e defina por quanto tempo guardar as mídias do atendimento.": {
    es: "Mantén los datos de la empresa y define cuánto tiempo conservar los archivos de la atención.",
  },
  "Crie chaves para conectar outros sistemas. Copie a chave ao criá-la: ela será exibida apenas uma vez.":
    {
      es: "Crea claves para conectar otros sistemas. Copia la clave al crearla: solo se mostrará una vez.",
    },
  "Acompanhe os pedidos de acesso e exclusão de dados dos seus clientes.": {
    es: "Sigue las solicitudes de acceso y eliminación de datos de tus clientes.",
  },
  "Ajuste seu nome, idioma, fuso horário e foto.": {
    es: "Ajusta tu nombre, idioma, zona horaria y foto.",
  },
  "O e-mail de acesso não pode ser alterado nesta tela.": {
    es: "El correo de acceso no se puede cambiar en esta pantalla.",
  },
  "Escolha quais avisos receber e por onde quer acompanhar.": {
    es: "Elige qué avisos recibir y dónde quieres seguirlos.",
  },
  "Traga pedidos, produtos e clientes da sua loja para o CRM.": {
    es: "Trae pedidos, productos y clientes de tu tienda al CRM.",
  },
  "Cobrança gerenciada pela equipe": { es: "Facturación gestionada por el equipo" },
  "Para consultar seu plano, faturas ou pagamentos, fale com a equipe responsável pelo seu acesso.":
    {
      es: "Para consultar tu plan, facturas o pagos, habla con el equipo responsable de tu acceso.",
    },
  "Defina as etapas da venda, os campos de cada oportunidade e os motivos de perda.": {
    es: "Define las etapas de la venta, los campos de cada oportunidad y los motivos de pérdida.",
  },
  ...
  "Encontre uma pessoa, consulte seu histórico e acompanhe a relação com seu negócio.": {
    es: "Encuentra a una persona, consulta su historial y sigue la relación con tu negocio.",
  },
  "Descreva como você atende. Revise, teste e publique quando o agente estiver pronto.": {
    es: "Describe cómo atiendes. Revisa, prueba y publica cuando el agente esté listo.",
  },

  "Você está aqui": { es: "Estás aquí" },
  "Como seguir por aqui": { es: "Cómo continuar aquí" },
  "Opções de conexão": { es: "Opciones de conexión" },
  "Cada conversa começa com uma conexão.": { es: "Cada conversación comienza con una conexión." },
  "Traga o WhatsApp e o Instagram para o mesmo lugar. A gente te guia na conexão.": {
    es: "Reúne WhatsApp e Instagram en un mismo lugar. Te guiamos en la conexión.",
  },
  "Conecte seu número e acompanhe as conversas da sua equipe.": {
    es: "Conecta tu número y sigue las conversaciones de tu equipo.",
  },
  "Veja as opções para receber as mensagens do Instagram no atendimento.": {
    es: "Consulta las opciones para recibir mensajes de Instagram en la atención.",
  },
  "Ver conexão do Instagram": { es: "Ver conexión de Instagram" },
  "Você escolhe o canal. Nós mostramos o próximo passo.": {
    es: "Tú eliges el canal. Nosotros te mostramos el siguiente paso.",
  },
  "Atenda com tudo à mão.": { es: "Atiende con todo a mano." },
  "Abra uma conversa, consulte o histórico e acompanhe o próximo contato.": {
    es: "Abre una conversación, consulta el historial y sigue el próximo contacto.",
  },
  "Uma conversa pode virar uma venda.": { es: "Una conversación puede convertirse en una venta." },
  "Organize as oportunidades no funil e registre o que precisa acontecer depois.": {
    es: "Organiza las oportunidades en el embudo y registra lo que debe ocurrir después.",
  },
  "Ensine uma vez. Aprimore sempre.": { es: "Enseña una vez. Mejora siempre." },
  "Descreva o atendimento, adicione conhecimento e revise o agente antes de publicar.": {
    es: "Describe la atención, añade conocimiento y revisa el agente antes de publicarlo.",
  },
  "Escolha o canal, siga a conexão e encontre as mensagens no Inbox.": {
    es: "Elige el canal, sigue la conexión y encuentra los mensajes en el Inbox.",
  },
  "Entenda o que pede sua atenção.": { es: "Entiende qué necesita tu atención." },
  "Acompanhe os resultados e volte à conversa ou ao funil para agir.": {
    es: "Sigue los resultados y vuelve a la conversación o al embudo para actuar.",
  },
  "Um espaço que funciona do seu jeito.": { es: "Un espacio que funciona a tu manera." },
  "Organize a equipe, ajuste o atendimento e cuide das permissões do seu negócio.": {
    es: "Organiza el equipo, ajusta la atención y gestiona los permisos de tu negocio.",
  },
  "Seu espaço está criado.": { es: "Tu espacio está creado." },
  "Você já pode explorar. As configurações abaixo ainda precisam ser concluídas para começar o atendimento.":
    {
      es: "Ya puedes explorar. Las configuraciones siguientes aún deben completarse para comenzar la atención.",
    },

  "IA gerenciada pelo escreve.ai. Você não precisa cadastrar uma chave.": {
    es: "IA gestionada por escreve.ai. No necesitas registrar una clave.",
  },
  "Conte sobre seu negócio, o que o agente deve fazer e quando chamar sua equipe.": {
    es: "Cuéntanos sobre tu negocio, qué debe hacer el agente y cuándo llamar a tu equipo.",
  },
  "Depois, revise as instruções e escolha onde ele vai atender. Salvar cria um rascunho; publicar libera o atendimento.":
    {
      es: "Después, revisa las instrucciones y elige dónde atenderá. Guardar crea un borrador; publicar habilita la atención.",
    },
  "A IA da sua empresa já está configurada para este agente.": {
    es: "La IA de tu empresa ya está configurada para este agente.",
  },
  "A IA ainda precisa ser preparada pelo administrador. Você pode configurar o agente manualmente enquanto isso.":
    {
      es: "El administrador todavía debe preparar la IA. Mientras tanto puedes configurar el agente manualmente.",
    },

  Site: { es: "Sitio web" },
  "Sobre a empresa": { es: "Sobre la empresa" },
  "Não foi possível carregar o enriquecimento.": { es: "No se pudo cargar el enriquecimiento." },
  "Sem dados de enriquecimento para este contato.": {
    es: "Sin datos de enriquecimiento para este contacto.",
  },
  ...
  "Dados públicos coletados na busca; podem ter mudado.": {
    es: "Datos públicos recopilados en la búsqueda; pueden haber cambiado.",
  },
  ...
  "A janela de atendimento fechou. Abra o Inbox para ver as opções deste canal.": {
    es: "La ventana de atención se cerró. Abre el Inbox para ver las opciones de este canal.",
  },

  "Assistente de voz": { es: "Asistente de voz" },
  "Não foi possível concluir. Confira sua conexão e tente novamente.": {
    es: "No se pudo completar la operación. Revisa tu conexión e inténtalo de nuevo.",
  },
  "Não foi possível confirmar o encerramento. Feche esta aba para interromper o microfone.": {
    es: "No se pudo confirmar la finalización. Cierra esta pestaña para detener el micrófono.",
  },
  "O teste de voz encontrou uma falha. Encerre e tente novamente; confira a permissão do microfone e o saldo da conta.":
    {
      es: "La prueba de voz falló. Finalízala e inténtalo de nuevo; revisa el permiso del micrófono y el saldo de la cuenta.",
    },
  "Não foi possível iniciar a voz. Permita o microfone neste site e confira sua conexão.": {
    es: "No se pudo iniciar la voz. Permite el uso del micrófono en este sitio y revisa tu conexión.",
  },
  "Um administrador pode configurar e testar o assistente de voz.": {
    es: "Un administrador puede configurar y probar el asistente de voz.",
  },
  "Escolha a voz, ajuste a abertura e converse com seu assistente antes de usá-lo.": {
    es: "Elige la voz, ajusta el saludo inicial y conversa con tu asistente antes de usarlo.",
  },
  ...
  "A chave fica protegida no CRM e é usada pelos assistentes de voz desta organização.": {
    es: "La clave queda protegida en el CRM y la utilizan los asistentes de voz de esta organización.",
  },
  ...
  "Começamos com as instruções salvas do agente. Os ajustes abaixo valem para a voz; ferramentas e materiais do CRM não são usados neste teste.":
    {
      es: "Partimos de las instrucciones guardadas del agente. Los ajustes siguientes se aplican a la voz; las herramientas y los materiales del CRM no se usan en esta prueba.",
    },
  ...
  "Use seu microfone. O teste consome créditos da ElevenLabs. O áudio não é gravado; a transcrição fica no provedor por até 7 dias.":
    {
      es: "Usa tu micrófono. La prueba consume créditos de ElevenLabs. El audio no se graba; la transcripción se conserva en el proveedor hasta 7 días.",
    },
  ...
  "A espera foi interrompida. O teste já enviado pode continuar no provedor.": {
    es: "Se ha dejado de esperar. La prueba ya enviada puede continuar en el proveedor.",
  },
  ...
  "Escreva como um cliente. O teste usa um rascunho pausado e consome créditos de IA, sem enviar mensagens aos seus contatos.":
    {
      es: "Escribe como un cliente. La prueba usa un borrador pausado y consume créditos de IA, sin enviar mensajes a tus contactos.",
    },
  "Mensagem do cliente para o teste": { es: "Mensaje del cliente para la prueba" },
  "Tenho interesse, mas preciso entender como isso ajudaria minha empresa.": {
    es: "Me interesa, pero necesito entender cómo ayudaría a mi empresa.",
  },
  ...
  "O agente não produziu uma resposta para esta mensagem.": {
    es: "El agente no generó una respuesta para este mensaje.",
  },
  "Resposta de um provedor de teste controlado; nenhuma IA externa foi chamada.": {
    es: "Respuesta de un proveedor de pruebas controlado; no se llamó a ninguna IA externa.",
  },
  "Revise a resposta: ela contém termos internos do sistema.": {
    es: "Revisa la respuesta: contiene términos internos del sistema.",
  },
  "Verificações que dependem de uma conversa real": {
    es: "Comprobaciones que dependen de una conversación real",
  },
  "Cada teste avalia uma mensagem. Ações sobre contatos e envios não são executados nesta simulação.":
    {
      es: "Cada prueba evalúa un mensaje. En esta simulación no se realizan acciones sobre contactos ni envíos.",
    },
  "Configurar assistente de voz neste rascunho": {
    es: "Configurar el asistente de voz en este borrador",
  },
  ...
  "Permissões: consultar contatos e atualizar negócios no funil escolhido.": {
    es: "Permisos: consultar contactos y actualizar negocios en el embudo elegido.",
  },
  "Agente publicado e selecionado.": { es: "Agente publicado y seleccionado." },
  "Configurar por conversa": { es: "Configurar conversando" },
  "Usar agente existente / configurar manualmente": {
    es: "Usar un agente existente / configurar manualmente",
  },
  ...
  "Agente pronto. Escolha o ritmo abaixo e inicie quando estiver preparado.": {
    es: "Agente listo. Elige el ritmo a continuación e inicia cuando estés preparado.",
  },
  "Resposta interrompida. Sua mensagem foi mantida para tentar novamente.": {
    es: "Respuesta interrumpida. Tu mensaje se ha conservado para volver a intentarlo.",
  },
  "Complete a configuração e recupere uma publicação pendente antes de testar.": {
    es: "Completa la configuración y recupera cualquier publicación pendiente antes de probar.",
  },
  ...
  "Quero montar um agente para descobrir o problema do cliente e qualificar interessados.": {
    es: "Quiero crear un agente para identificar el problema del cliente y calificar interesados.",
  },
  ...
  "Quero que o agente entenda a necessidade e convide o cliente para uma conversa com a equipe.": {
    es: "Quiero que el agente entienda la necesidad e invite al cliente a conversar con el equipo.",
  },
  "Configuração por conversa": { es: "Configuración mediante conversación" },
  "Conte o que você quer alcançar. O resumo acompanha suas escolhas.": {
    es: "Cuéntanos qué quieres lograr. El resumen se actualiza con tus elecciones.",
  },
  ...
  "O que você oferece e o que quer descobrir na conversa com essas empresas?": {
    es: "¿Qué ofreces y qué quieres descubrir al conversar con estas empresas?",
  },
  "Organizando suas escolhas e preparando a próxima pergunta…": {
    es: "Organizando tus elecciones y preparando la siguiente pregunta…",
  },
  "Preparando resposta…": { es: "Preparando respuesta…" },
  "Rascunho salvo e pausado. Você pode testar e ajustar antes de publicar.": {
    es: "Borrador guardado y pausado. Puedes probarlo y ajustarlo antes de publicar.",
  },
  "Ao publicar, o agente poderá atender mensagens recebidas neste canal. A prospecção começa apenas quando você iniciar a campanha.":
    {
      es: "Al publicar, el agente podrá responder a los mensajes recibidos en este canal. La prospección solo comienza cuando inicies la campaña.",
    },
  ...
  "A última criação ainda precisa de confirmação. Recupere a mesma solicitação para evitar outro agente.":
    {
      es: "La última creación aún necesita confirmación. Recupera la misma solicitud para evitar crear otro agente.",
    },
  ...
  "Conta conectada. Agora escolha como seu assistente deve falar.": {
    es: "Cuenta conectada. Ahora elige cómo debe hablar tu asistente.",
  },
  "Assistente de voz salvo. Você já pode conversar com ele aqui.": {
    es: "Asistente de voz guardado. Ya puedes conversar con él aquí.",
  },
  ...
  "Salve as alterações para testar esta versão.": {
    es: "Guarda los cambios para probar esta versión.",
  },
  ...
  "Esta campanha já começou a preparar contatos. Sua configuração foi preservada para retomar com segurança.":
    {
      es: "Esta campaña ya empezó a preparar contactos. Su configuración se conservó para reanudar con seguridad.",
    },
  ...
  "Revise o ritmo e inicie a campanha quando estiver pronto.": {
    es: "Revisa el ritmo e inicia la campaña cuando estés listo.",
  },
  "Não foi possível continuar a conversa.": { es: "No se pudo continuar la conversación." },
  "Ainda faltam informações. Continue a conversa para completar a configuração.": {
    es: "Todavía falta información. Continúa la conversación para completar la configuración.",
  },
  "Não foi possível criar o agente.": { es: "No se pudo crear el agente." },
  "Vamos montar seu agente": { es: "Vamos a preparar tu agente" },
  "Conte o que você precisa. Eu preparo as instruções e permissões com você.": {
    es: "Cuéntame qué necesitas. Preparo las instrucciones y los permisos contigo.",
  },
  ...
  "O que você quer que este agente ofereça e consiga descobrir na conversa com essas empresas?": {
    es: "¿Qué quieres que este agente ofrezca y averigüe al conversar con estas empresas?",
  },
  ...
  "Permissões: consultar contatos e atualizar negócios neste funil.": {
    es: "Permisos: consultar contactos y actualizar negocios en este embudo.",
  },
  "Manter a continuidade do agente neste canal": {
    es: "Mantener la continuidad del agente en este canal",
  },
  "Dar continuidade com o mesmo agente, salvo mudança de assunto ou transferência. Esta configuração vale para as conversas deste canal.":
    {
      es: "Continuar con el mismo agente, salvo cambio de tema o transferencia. Esta configuración se aplica a las conversaciones de este canal.",
    },
  "O agente será publicado e poderá atender mensagens recebidas neste canal. As abordagens só começam quando você iniciar a campanha.":
    {
      es: "El agente se publicará y podrá atender mensajes recibidos en este canal. Los contactos solo comienzan cuando inicies la campaña.",
    },
  ...
  "Mantenha os dados desta tentativa. Recuperar a criação consulta a mesma solicitação, sem criar outro agente.":
    {
      es: "Conserva los datos de este intento. Recuperar la creación consulta la misma solicitud, sin crear otro agente.",
    },
  ...
  "Encontre empresas, aborde aos poucos e acompanhe quem avança na conversa.": {
    es: "Encuentra empresas, contacta gradualmente y sigue quién avanza en la conversación.",
  },
  ...
  "A chave fica cifrada no servidor. Cada busca tem seu próprio limite de gasto.": {
    es: "La clave queda cifrada en el servidor. Cada búsqueda tiene su propio límite de gasto.",
  },
  "1. Encontrar empresas": { es: "1. Encontrar empresas" },
  "Solicitação registrada. Acompanhe o estado da busca nesta tela.": {
    es: "Solicitud registrada. Sigue el estado de la búsqueda en esta pantalla.",
  },
  ...
  "Enriquecer com e-mails comerciais e redes encontradas no site": {
    es: "Enriquecer con correos comerciales y redes encontradas en el sitio",
  },
  "A pesquisa usa seu saldo da Apify. A quantidade encontrada pode ser menor que o limite. Nenhuma abordagem começa nesta etapa.":
    {
      es: "La búsqueda utiliza tu saldo de Apify. La cantidad encontrada puede ser menor que el límite. En esta etapa no se inicia ningún contacto.",
    },
  "Aguarde…": { es: "Espera…" },
  ...
  "Escolha um segmento e uma região. Depois da pesquisa, defina como a IA deve abordar e o que precisa confirmar para qualificar.":
    {
      es: "Elige un segmento y una región. Después de la búsqueda, define cómo debe contactar la IA y qué necesita confirmar para calificar.",
    },
  Encontrados: { es: "Encontrados" },
  "Na fila": { es: "En cola" },
  Responderam: { es: "Respondieron" },
  Qualificados: { es: "Calificados" },
  "resultados repetidos ou indisponíveis foram desconsiderados.": {
    es: "resultados repetidos o no disponibles fueron descartados.",
  },
  "Ritmo:": { es: "Ritmo:" },
  ...
  "A IA usa o agente escolhido para abrir a conversa e atender as respostas. As proteções do canal continuam valendo.":
    {
      es: "La IA usa el agente elegido para abrir la conversación y atender las respuestas. Las protecciones del canal siguen vigentes.",
    },
  "Campanha iniciada. A primeira abordagem será preparada após um minuto.": {
    es: "Campaña iniciada. El primer contacto se preparará después de un minuto.",
  },
  "Escolha um agente publicado": { es: "Elige un agente publicado" },
  "Publique e ative um agente para continuar.": {
    es: "Publica y activa un agente para continuar.",
  },
  ...
  "Descreva sua oferta e o objetivo da primeira conversa.": {
    es: "Describe tu oferta y el objetivo de la primera conversación.",
  },
  ...
  "Ex.: confirmou a necessidade, participa da decisão e deseja conversar sobre a solução.": {
    es: "Ej.: confirmó la necesidad, participa en la decisión y desea conversar sobre la solución.",
  },
  "Máximo em 24 horas": { es: "Máximo en 24 horas" },
  "Intervalo mínimo (minutos)": { es: "Intervalo mínimo (minutos)" },
  "Referência da avaliação de legítimo interesse": {
    es: "Referencia de la evaluación de interés legítimo",
  },
  "Informe a referência real da avaliação que fundamenta esta prospecção. Isso não registra consentimento dos contatos.":
    {
      es: "Indica la referencia real de la evaluación que fundamenta esta prospección. Esto no registra consentimiento de los contactos.",
    },
  "Ao iniciar, os contatos novos com telefone entram no funil. Contatos já existentes são preservados. A fila faz uma primeira abordagem; respostas seguem no Inbox. Uma mensagem já em transmissão pode concluir após a pausa.":
    {
      es: "Al iniciar, los contactos nuevos con teléfono entran en el embudo. Los contactos existentes se conservan. La cola realiza un primer contacto; las respuestas siguen en Inbox. Un mensaje que ya se está transmitiendo puede completarse después de la pausa.",
    },
  ...
  "Encontrado é diferente de qualificado. A qualificação depende do que for confirmado na conversa.":
    {
      es: "Encontrado es diferente de calificado. La calificación depende de lo que se confirme en la conversación.",
    },
  Empresa: { es: "Empresa" },
  ...
  "Aguardando a confirmação no celular. Se o código expirar, gere outro.": {
    es: "Esperando la confirmación en el celular. Si el código caduca, genera otro.",
  },
  "No celular: WhatsApp → Aparelhos conectados → Conectar um aparelho → Conectar com número de telefone. Digite o código mostrado aqui.":
    {
      es: "En el celular: WhatsApp → Dispositivos vinculados → Vincular un dispositivo → Vincular con número de teléfono. Introduce el código mostrado aquí.",
    },
  "Se essa opção não aparecer no celular, use o QR Code.": {
    es: "Si esta opción no aparece en el celular, usa el código QR.",
  },
  "Escolha QR Code ou código de pareamento e confirme no WhatsApp do celular.": {
    es: "Elige código QR o código de vinculación y confirma en WhatsApp en el celular.",
  },
  ...
  "Conecte com QR Code ou digite um código de pareamento no WhatsApp do celular.": {
    es: "Conecta con código QR o introduce un código de vinculación en WhatsApp en el celular.",
  },
  "Informe o telefone completo com código do país e DDD.": {
    es: "Introduce el teléfono completo con código de país y área.",
  },
  "Não foi possível gerar o código. Tente novamente.": {
    es: "No se pudo generar el código. Inténtalo de nuevo.",
  },
  "Não foi possível consultar esta conexão. Tente novamente.": {
    es: "No se pudo consultar esta conexión. Inténtalo de nuevo.",
  },
  "Este canal foi excluído. Conecte um número para voltar a atender.": {
    es: "Este canal fue eliminado. Conecta un número para volver a atender.",
  },
  "Este canal não conecta por código de pareamento.": {
    es: "Este canal no se conecta mediante código de vinculación.",
  },
  "O serviço de conexão não está configurado.": {
    es: "El servicio de conexión no está configurado.",
  },
  "Aguarde 30 segundos antes de pedir outro código.": {
    es: "Espera 30 segundos antes de solicitar otro código.",
  },
  ...
  "A conexão ainda não está pronta. Aguarde ou use Reconectar e tente novamente.": {
    es: "La conexión aún no está lista. Espera o usa Reconectar e inténtalo de nuevo.",
  },
  "Não foi possível gerar o código. Confira o número e tente novamente, ou use o QR Code.": {
    es: "No se pudo generar el código. Revisa el número e inténtalo de nuevo, o usa el código QR.",
  },
  "O serviço de conexão não respondeu. Tente novamente ou use o QR Code.": {
    es: "El servicio de conexión no respondió. Inténtalo de nuevo o usa el código QR.",
  },

  "Versão publicada": { es: "Versión publicada" },
  "Publicado em": { es: "Publicado el" },
  "Nenhum agente publicado": { es: "Ningún agente publicado" },
  "Não foi possível carregar o agente do tenant. Tente recarregar a página.": {
    es: "No se pudo cargar el agente del tenant. Intenta recargar la página.",
  },
  ...
  "Feriado, férias, viagem. Nesses dias o sistema deixa de oferecer horários — e o que já estava marcado continua marcado, para você decidir o que fazer com cada um.":
    {
      es: "Feriado, vacaciones, viaje. En esos días el sistema deja de ofrecer horarios — y lo que ya estaba agendado sigue agendado, para que decidas qué hacer con cada uno.",
    },
  ...
  "Abra o atendimento e diga o que fazer: concluir, pedir informação ao cliente ou passar para uma pessoa.":
    {
      es: "Abre la atención y di qué hacer: concluir, pedir información al cliente o pasarla a una persona.",
    },
  "Um atendimento espera decisão da equipe": { es: "Una atención espera decisión del equipo" },
  "Soltar o horário de um pedido não confirmado após (minutos)": {
    es: "Liberar el horario de una solicitud no confirmada después de (minutos)",
  },
  "Vale só para tipos de atendimento que pedem confirmação. Enquanto o pedido espera, o horário fica reservado e ninguém mais o pega; passado o prazo sem decisão, ele volta a ser oferecido. O cliente não é avisado, e o pedido continua na fila.":
    {
      es: "Vale solo para tipos de atención que piden confirmación. Mientras la solicitud espera, el horario queda reservado y nadie más lo toma; pasado el plazo sin decisión, vuelve a ofrecerse. El cliente no recibe aviso, y la solicitud sigue en la fila.",
    },
  ...
  "Não foi possível carregar a proteção de envio desta conexão. Ela pode ter sido removida, ou esta lista está desatualizada.":
    {
      es: "No se pudo cargar la protección de envío de esta conexión. Puede que se haya eliminado, o esta lista está desactualizada.",
    },
  ...
  "Aguarde uma nova mensagem do cliente para reabrir o atendimento nesta rede.": {
    es: "Espera un nuevo mensaje del cliente para reabrir la atención en esta red.",
  },
  "aguardando o cliente": { es: "esperando al cliente" },
  "Tempo restante para responder. Uma nova mensagem do cliente reabre a janela.": {
    es: "Tiempo restante para responder. Un nuevo mensaje del cliente reabre la ventana.",
  },
  ...
  "É com estas duas informações que o sistema confere que cada mensagem recebida pelo número oficial veio mesmo da Meta. Elas valem para a instalação inteira — cada empresa conecta o próprio número depois, em Conexões.":
    {
      es: "Con estos dos datos el sistema comprueba que cada mensaje recibido por el número oficial vino realmente de Meta. Valen para toda la instalación — cada empresa conecta su propio número después, en Conexiones.",
    },
  "Não deu para ler a configuração salva agora, então o que aparece abaixo pode não ser o que está valendo. Recarregue a página antes de trocar qualquer coisa.":
    {
      es: "No se pudo leer la configuración guardada ahora, así que lo que aparece abajo puede no ser lo que está vigente. Recarga la página antes de cambiar cualquier cosa.",
    },
  ...
  "Fica no painel da Meta, em Configurações do app › Básico. Ela é guardada cifrada e nunca volta a aparecer nesta tela.":
    {
      es: "Está en el panel de Meta, en Configuración de la app › Básica. Se guarda cifrada y nunca vuelve a aparecer en esta pantalla.",
    },
  "Esta instalação já tem a chave e o token no arquivo de configuração do servidor. O que você salvar aqui passa a valer no lugar deles — e, a partir daí, é o token desta tela que precisa estar colado no painel da Meta.":
    {
      es: "Esta instalación ya tiene la clave y el token en el archivo de configuración del servidor. Lo que guardes aquí pasa a valer en su lugar — y, desde entonces, es el token de esta pantalla el que tiene que estar pegado en el panel de Meta.",
    },
  ...
  "Ainda não existe. Ele é criado pelo sistema na primeira vez que você salva a chave secreta — ninguém precisa inventar nada.":
    {
      es: "Todavía no existe. El sistema lo crea la primera vez que guardas la clave secreta — nadie tiene que inventar nada.",
    },
  ...
  "Por segurança, ele não aparece de novo depois que você sair desta página. Se perder, é só gerar outro aqui.":
    {
      es: "Por seguridad, no vuelve a aparecer después de que salgas de esta página. Si lo pierdes, basta con generar otro aquí.",
    },
  "No painel da Meta, em WhatsApp › Configuração › Webhook, este token vai no campo “Verificar token”. O outro campo, “URL de callback”, é de cada número: ele aparece em Conexões › API Oficial (Meta), depois que o número é conectado. Abra Conexões em outra aba, para não perder o token desta página.":
    {
      es: "En el panel de Meta, en WhatsApp › Configuración › Webhook, este token va en el campo “Verificar token”. El otro campo, “URL de devolución de llamada”, es de cada número: aparece en Conexiones › API Oficial (Meta), después de conectar el número. Abre Conexiones en otra pestaña, para no perder el token de esta página.",
    },
  "Abrir Conexões em outra aba": { es: "Abrir Conexiones en otra pestaña" },
  "Abrir API Oficial (Meta) na administração": {
    es: "Abrir API Oficial (Meta) en la administración",
  },
  ...
  "O token atual deixa de valer na hora. As mensagens que já chegam continuam chegando, porque elas são conferidas pela chave secreta. O que muda: a Meta só consegue confirmar o endereço do webhook de novo depois que você colar o token novo no painel dela.":
    {
      es: "El token actual deja de valer en el acto. Los mensajes que ya llegan siguen llegando, porque se comprueban con la clave secreta. Lo que cambia: Meta solo puede volver a confirmar la dirección del webhook después de que pegues el token nuevo en su panel.",
    },
  "A chave parece incompleta. Copie de novo do painel da Meta — ela tem 32 caracteres.": {
    es: "La clave parece incompleta. Cópiala de nuevo del panel de Meta — tiene 32 caracteres.",
  },
  "Cadastre a chave secreta do aplicativo primeiro. Sem ela o token não vale.": {
    es: "Registra primero la clave secreta de la aplicación. Sin ella el token no vale.",
  },
  "Nada mudou. Digite uma chave nova para substituir a atual.": {
    es: "Nada cambió. Escribe una clave nueva para reemplazar la actual.",
  },
  "Não consegui conferir o que já está gravado, então nada foi alterado. Tente de novo em instantes.":
    {
      es: "No pude comprobar lo que ya está guardado, así que no se cambió nada. Inténtalo de nuevo en unos instantes.",
    },
  ...
  "Não deu para copiar. Selecione o texto e copie à mão.": {
    es: "No se pudo copiar. Selecciona el texto y cópialo a mano.",
  },
  "Já cadastrado na administração da instalação. Ele aparece uma vez só, quando é gerado — se não foi guardado, quem administra a instalação gera outro em Admin › API Oficial (Meta).":
    {
      es: "Ya registrado en la administración de la instalación. Aparece una sola vez, cuando se genera — si no se guardó, quien administra la instalación genera otro en Admin › API Oficial (Meta).",
    },
  "Ainda não configurado. Quem administra a instalação cadastra em Admin › API Oficial (Meta), e o token aparece lá pronto para copiar.":
    {
      es: "Todavía no configurado. Quien administra la instalación lo registra en Admin › API Oficial (Meta), y el token aparece allí listo para copiar.",
    },
  "cifra indisponível nesta instalação (GUC app.nuvemshop_oauth_key ausente) — o verify token não foi gravado":
    {
      es: "cifrado no disponible en esta instalación (GUC app.nuvemshop_oauth_key ausente) — el verify token no fue guardado",
    },
  ...
  "O áudio desta ligação está em outra aba": {
    es: "El audio de esta llamada está en otra pestaña",
  },
  "Ouvir aqui": { es: "Escuchar aquí" },
  "O áudio caiu": { es: "El audio se cayó" },
  "Não consegui abrir o áudio. Confira o microfone.": {
    es: "No pude abrir el audio. Revisa el micrófono.",
  },
  ...
  "Esta chave de idempotência já foi usada com outro conteúdo.": {
    es: "Esta clave de idempotencia ya fue usada con otro contenido.",
  },
  ...
  "As colunas de cada funil, o vocabulário do negócio e os motivos de perda.": {
    es: "Las columnas de cada embudo, el vocabulario del negocio y los motivos de pérdida.",
  },
  "As conversas de WhatsApp, com você e a IA atendendo lado a lado.": {
    es: "Las conversaciones de WhatsApp, contigo y la IA atendiendo lado a lado.",
  },
  ...
  "Avise outros sistemas quando algo acontecer aqui dentro.": {
    es: "Avisa a otros sistemas cuando algo ocurra aquí dentro.",
  },
  "Conectar a conta de anúncios para ler o desempenho das campanhas.": {
    es: "Conectar la cuenta de anuncios para leer el rendimiento de las campañas.",
  },
  "Conecte a loja para trazer pedidos e clientes para dentro do CRM.": {
    es: "Conecta la tienda para traer pedidos y clientes al CRM.",
  },
  "Devolver ao anúncio as vendas que ele trouxe, para ele aprender a procurar mais clientes parecidos.":
    {
      es: "Devolver al anuncio las ventas que trajo, para que aprenda a buscar más clientes parecidos.",
    },
  "Funil e performance por atendente nos últimos 30 dias.": {
    es: "Embudo y rendimiento por agente en los últimos 30 días.",
  },
  "O catálogo da loja, com o preço que o atendente de IA responde.": {
    es: "El catálogo de la tienda, con el precio que responde el agente de IA.",
  },
  "O que se pode marcar, quanto dura, onde acontece e quem atende.": {
    es: "Qué se puede agendar, cuánto dura, dónde ocurre y quién atiende.",
  },
  "Quanto custou cada resultado das campanhas que trazem gente para cá.": {
    es: "Cuánto costó cada resultado de las campañas que traen gente aquí.",
  },
  "Quem esfriou e ainda está aberto — o que corre risco de morrer sem resposta.": {
    es: "Quién se enfrió y sigue abierto — lo que corre riesgo de morir sin respuesta.",
  },
  ...
  "Relatório do que a equipe e os agentes fizeram no período: quanto, quem e de que tipo.": {
    es: "Informe de lo que el equipo y los agentes hicieron en el período: cuánto, quién y de qué tipo.",
  },
  "Scripts salvos para responder mais rápido, seus ou da equipe.": {
    es: "Scripts guardados para responder más rápido, tuyos o del equipo.",
  },
  "Se o agente está melhorando, onde ele erra e o que falta ensinar.": {
    es: "Si el agente está mejorando, dónde se equivoca y qué falta enseñar.",
  },
  "Seus funis de venda — clique em um para abrir o quadro de clientes.": {
    es: "Tus embudos de venta — haz clic en uno para abrir el tablero de clientes.",
  },
  ...
  "Marcado como falta — o horário volta a ficar livre.": {
    es: "Marcado como inasistencia — el horario vuelve a quedar libre.",
  },
  Mídia: { es: "Multimedia" },
  ...
  "Conecte suas contas e receba mensagens no atendimento.": {
    es: "Conecta tus cuentas y recibe mensajes en atención.",
  },
  "A autorização não foi concluída. Tente conectar novamente e aceite as permissões necessárias.": {
    es: "La autorización no se completó. Intenta conectar de nuevo y acepta los permisos necesarios.",
  },
  "Autorização concluída. Confira a conta na lista e ative o atendimento, quando disponível.": {
    es: "Autorización completada. Comprueba la cuenta en la lista y activa la atención cuando esté disponible.",
  },
  "Vincular o provedor": { es: "Vincular el proveedor" },
  "A chave fica cifrada no servidor e não é exibida novamente.": {
    es: "La clave se guarda cifrada en el servidor y no se vuelve a mostrar.",
  },
  ...
  "Você autoriza na própria rede e retorna ao CRM. Cada perfil comporta uma conta por rede; use a mesma conta ao reconectar.":
    {
      es: "Autorizas en la propia red y vuelves al CRM. Cada perfil admite una cuenta por red; usa la misma cuenta al reconectar.",
    },
  Vinculada: { es: "Vinculada" },
  "Verificar conexão": { es: "Verificar conexión" },
  "Receber no atendimento": { es: "Recibir en atención" },
  "Recebimento configurado. Novas mensagens entram na caixa de entrada.": {
    es: "Recepción configurada. Los nuevos mensajes llegan a la bandeja de entrada.",
  },
  "O recebimento precisa de atenção. Confira a conexão antes de atender.": {
    es: "La recepción requiere atención. Comprueba la conexión antes de atender.",
  },
  "Ative para receber novas conversas. A IA começa pausada para evitar respostas duplicadas com outras automações.":
    {
      es: "Activa para recibir nuevas conversaciones. La IA empieza pausada para evitar respuestas duplicadas con otras automatizaciones.",
    },
  "Conta disponível no provedor. O atendimento por mensagens desta rede ainda não está integrado ao CRM.":
    {
      es: "Cuenta disponible en el proveedor. La atención por mensajes de esta red todavía no está integrada en el CRM.",
    },
  "Nenhuma conta conectada neste perfil. Autorize uma rede para começar.": {
    es: "No hay cuentas conectadas en este perfil. Autoriza una red para empezar.",
  },
  ...
  "As mensagens chegam para atendimento humano. A IA está pausada neste canal.": {
    es: "Los mensajes llegan para atención humana. La IA está pausada en este canal.",
  },
  ...
  "Pause a IA para manter o atendimento humano ou libere as respostas automáticas neste canal.": {
    es: "Pausa la IA para mantener la atención humana o habilita las respuestas automáticas en este canal.",
  },
  "As mensagens continuam chegando à caixa de entrada para sua equipe responder. Confira outras automações da conta antes de liberar a IA aqui.":
    {
      es: "Los mensajes siguen llegando a la bandeja de entrada para que tu equipo responda. Revisa otras automatizaciones de la cuenta antes de habilitar la IA aquí.",
    },
  ...
  "Não foi possível carregar as redes sociais.": {
    es: "No se pudieron cargar las redes sociales.",
  },
  "Reconfigurar integração": { es: "Reconfigurar integración" },

  "Escreve aí": { es: "Escribe aquí" },
  "Escreve aí.": { es: "Escribe aquí." },
  "SEU ESPAÇO": { es: "TU ESPACIO" },
  "Todas as ferramentas": { es: "Todas las herramientas" },
  "Seu espaço": { es: "Tu espacio" },
  "WhatsApp · Instagram · Conteúdos": { es: "WhatsApp · Instagram · Contenidos" },
  "Tudo conectado. Do seu jeito.": { es: "Todo conectado. A tu manera." },
  "Seu próximo passo?": { es: "¿Tu próximo paso?" },
  "Converse com o conteúdo do seu CRM. Encontre informações, entenda suas conversas e acompanhe o funil.":
    {
      es: "Conversa con el contenido de tu CRM. Encuentra información, entiende tus conversaciones y sigue el embudo.",
    },
  "Conversa com seu CRM": { es: "Conversación con tu CRM" },
  "Fontes consultadas": { es: "Fuentes consultadas" },
  "Sobre esta consulta": { es: "Sobre esta consulta" },
  "O que você quer saber sobre seu CRM?": { es: "¿Qué quieres saber sobre tu CRM?" },
  "Pergunte sobre uma conversa, uma oportunidade ou um conteúdo…": {
    es: "Pregunta sobre una conversación, una oportunidad o un contenido…",
  },
  Consultar: { es: "Consultar" },
  "Onde consultar": { es: "Dónde consultar" },
  "Meu espaço": { es: "Mi espacio" },
  Conteúdos: { es: "Contenidos" },
  Consultando: { es: "Consultando" },
  "Enviar pergunta": { es: "Enviar pregunta" },
  "Consultando o conteúdo do seu espaço…": { es: "Consultando el contenido de tu espacio…" },
  "Consulta seus dados com suas permissões. Nenhuma mensagem é enviada aos clientes.": {
    es: "Consulta tus datos con tus permisos. No se envían mensajes a los clientes.",
  },
  "Continue no seu espaço": { es: "Continúa en tu espacio" },
  "A conexão falhou. Sua pergunta foi mantida; tente novamente.": {
    es: "La conexión falló. Tu pregunta se ha conservado; inténtalo de nuevo.",
  },
  "Resuma as conversas recentes": { es: "Resume las conversaciones recientes" },
  "Quais oportunidades precisam de atenção?": { es: "¿Qué oportunidades necesitan atención?" },
  "Encontre uma informação nos meus conteúdos": { es: "Encuentra información en mis contenidos" },
  "Configurar credenciais de IA": { es: "Configurar credenciales de IA" },
  "Agentes de IA": { es: "Agentes de IA" },
  "Ordem de preferência": { es: "Orden de preferencia" },
  Instruções: { es: "Instrucciones" },
  "Ações por atendimento": { es: "Acciones por atención" },
  "Volume de texto": { es: "Volumen de texto" },
  "Custo máximo": { es: "Costo máximo" },
  "Mensagens anteriores": { es: "Mensajes anteriores" },
  "Tamanho do histórico": { es: "Tamaño del historial" },
  "Tamanho por bolha": { es: "Tamaño por burbuja" },
  "Modelo do operador": { es: "Modelo del operador" },
  "Capacidades do operador": { es: "Capacidades del operador" },
  Materiais: { es: "Materiales" },
  ...
  "Não foi possível confirmar o salvamento. Suas alterações continuam nesta tela. Tente novamente.":
    {
      es: "No se pudo confirmar el guardado. Tus cambios siguen en esta pantalla. Inténtalo de nuevo.",
    },
  "Seu jeito de atender começa aqui. Escreve aí.": {
    es: "Tu forma de atender empieza aquí. Escribe aquí.",
  },
  "Revise os campos para salvar.": { es: "Revisa los campos para guardar." },
  Revisar: { es: "Revisar" },
  "Configuração da IA": { es: "Configuración de IA" },
  "Modelo pendente": { es: "Modelo pendiente" },
  "Chave da instalação": { es: "Clave de la instalación" },
  "Chave pendente": { es: "Clave pendiente" },
  "Opções avançadas": { es: "Opciones avanzadas" },
  "ações por atendimento": { es: "acciones por atención" },
  "centavos por atendimento": { es: "centavos por atención" },
  "Detalhes técnicos": { es: "Detalles técnicos" },
  "A resposta não chegou. Sua mensagem foi mantida; tente novamente.": {
    es: "La respuesta no llegó. Tu mensaje se ha conservado; inténtalo de nuevo.",
  },
  "Configurar manualmente": { es: "Configurar manualmente" },
  "Voltar à conversa": { es: "Volver a la conversación" },
  "Criar agente por conversa": { es: "Crear agente por conversación" },
  "O que seu agente precisa fazer?": { es: "¿Qué necesita hacer tu agente?" },
  "Conte como você quer atender. A conversa organiza uma proposta que você pode revisar e ajustar.":
    {
      es: "Cuenta cómo quieres atender. La conversación organiza una propuesta que puedes revisar y ajustar.",
    },
  "Conversa de criação": { es: "Conversación de creación" },
  "Pode começar pelo seu negócio, por uma tarefa ou pelo que hoje toma seu tempo. Eu pergunto só o que faltar.":
    {
      es: "Puedes empezar por tu negocio, una tarea o lo que hoy te quita tiempo. Solo preguntaré lo que falte.",
    },
  "Preparando sua proposta…": { es: "Preparando tu propuesta…" },
  "O que você quer ajustar?": { es: "¿Qué quieres ajustar?" },
  "Conte sua ideia": { es: "Cuenta tu idea" },
  "Quero um agente que atenda os interessados, explique meus serviços e organize as oportunidades no funil…":
    {
      es: "Quiero un agente que atienda a los interesados, explique mis servicios y organice las oportunidades en el embudo…",
    },
  "Ver configuração da IA": { es: "Ver configuración de IA" },
  "Ctrl/⌘ + Enter para enviar": { es: "Ctrl/⌘ + Enter para enviar" },
  "Esta conversa prepara uma proposta. O agente só é salvo no editor e só atende depois de você publicar.":
    {
      es: "Esta conversación prepara una propuesta. El agente solo se guarda en el editor y solo atiende después de publicarlo.",
    },
  "Proposta do agente": { es: "Propuesta del agente" },
  "Proposta ainda não salva": { es: "Propuesta aún no guardada" },
  "Seu agente": { es: "Tu agente" },
  "Capacidades sugeridas": { es: "Capacidades sugeridas" },
  "Marque apenas o que autoriza levar ao rascunho. Nenhuma sugestão é ligada sozinha.": {
    es: "Marca solo lo que autorizas llevar al borrador. Ninguna sugerencia se activa sola.",
  },
  ...
  "Nova conversa": { es: "Nueva conversación" },
  "Seu próximo agente começa com uma ideia.": { es: "Tu próximo agente empieza con una idea." },
  "Conte o que precisa. A gente organiza com você.": {
    es: "Cuenta qué necesitas. Lo organizamos contigo.",
  },
  "Ideias para começar": { es: "Ideas para empezar" },
  "O que você quer facilitar hoje?": { es: "¿Qué quieres facilitar hoy?" },
  "Responder clientes": { es: "Responder a clientes" },
  "Organizar vendas": { es: "Organizar ventas" },
  "Agendar horários": { es: "Agendar citas" },
  "Quero responder dúvidas sobre meus serviços e chamar minha equipe quando precisar.": {
    es: "Quiero responder preguntas sobre mis servicios y llamar a mi equipo cuando sea necesario.",
  },
  "Quero entender o interesse dos clientes e organizar as oportunidades no funil.": {
    es: "Quiero entender el interés de los clientes y organizar las oportunidades en el embudo.",
  },
  "Quero ajudar meus clientes a escolher um horário para serem atendidos.": {
    es: "Quiero ayudar a mis clientes a elegir un horario para ser atendidos.",
  },
  "Ex.: quero responder dúvidas sobre meus serviços e chamar minha equipe quando precisar.": {
    es: "Ej.: quiero responder preguntas sobre mis servicios y llamar a mi equipo cuando sea necesario.",
  },
  "Você revisa tudo antes de ativar.": { es: "Revisas todo antes de activarlo." },
  "Prévia do agente": { es: "Vista previa del agente" },
  "Seu agente, tomando forma": { es: "Tu agente, tomando forma" },
  "O que ele faz": { es: "Qué hace" },
  "Como ele conversa": { es: "Cómo conversa" },
  "Quando chama você": { es: "Cuándo te llama" },
  "Primeiro a ideia. Depois os detalhes.": { es: "Primero la idea. Después los detalles." },
  "O valor mínimo é": { es: "El valor mínimo es" },
  "O valor máximo é": { es: "El valor máximo es" },
  "Confira o valor deste campo.": { es: "Revisa el valor de este campo." },
  "O que vamos resolver hoje?": { es: "¿Qué vamos a resolver hoy?" },
  "Converse com o conteúdo do seu negócio.": { es: "Conversa con el contenido de tu negocio." },
  "Mais opções": { es: "Más opciones" },
  Personalizados: { es: "Personalizados" },
  "Do seu jeito": { es: "A tu manera" },
  "Cole o endereço público da sua foto.": { es: "Pega la dirección pública de tu foto." },
  Preferências: { es: "Preferencias" },
  Começar: { es: "Empezar" },
  Prévia: { es: "Vista previa" },

  "Quem é este funcionário": { es: "Quién es este empleado" },
  "Funcionário duplicado.": { es: "Empleado duplicado." },
  "Funcionário reativado.": { es: "Empleado reactivado." },
  "Funcionário pausado.": { es: "Empleado pausado." },
  "O funcionário deixa de responder e sai da equipe ativa. Treinamentos publicados e histórico são preservados para auditoria. Não é possível desarquivar pela interface nesta versão.":
    {
      es: "El empleado deja de responder y sale del equipo activo. Los entrenamientos publicados y el historial se conservan para auditoría. No es posible desarchivarlo desde la interfaz en esta versión.",
    },
  "Funcionário arquivado.": { es: "Empleado archivado." },
  "Equipe atual": { es: "Equipo actual" },
  "Acompanhe quem está em rascunho, publicado, pausado ou arquivado.": {
    es: "Consulta quién está en borrador, publicado, pausado o archivado.",
  },
  "Função personalizada": { es: "Función personalizada" },
  "Nenhum funcionário corresponde aos filtros atuais.": {
    es: "Ningún empleado coincide con los filtros actuales.",
  },
  "Buscar funcionário…": { es: "Buscar empleado…" },
  "Buscar funcionários": { es: "Buscar empleados" },
  "Equipe pronta para montar": { es: "Equipo listo para montar" },
  "Contrate por função": { es: "Contrata por función" },
  "Cada funcionário começa com missão, limites e linguagem da função. Você revisa o treinamento, escolhe o número e publica quando estiver pronto.":
    {
      es: "Cada empleado comienza con la misión, los límites y el lenguaje de su función. Revisas el entrenamiento, eliges el número y publicas cuando esté listo.",
    },
  contratado: { es: "contratado" },
  "Ainda não contratado": { es: "Aún no contratado" },
  "na equipe": { es: "en el equipo" },
  "Adicionar outro": { es: "Añadir otro" },
  ...
  "Ver toda a equipe": { es: "Ver todo el equipo" },
  "Montar a equipe": { es: "Montar el equipo" },
  "Sua equipe digital por função: SDR, BDR, Closer, atendimento e operações.": {
    es: "Tu equipo digital por función: SDR, BDR, Closer, atención y operaciones.",
  },
  "Instagram Growth": { es: "Crecimiento en Instagram" },
  "Responda comentários com DMs e gere leads no Instagram.": {
    es: "Responde comentarios con mensajes directos y genera leads en Instagram.",
  },
  "Cliente Oculto": { es: "Cliente misterioso" },
  "Auditoria com IA do atendimento e tempo de resposta.": {
    es: "Auditoría con IA de la atención y el tiempo de respuesta.",
  },
  "Qualidade e Auditoria": { es: "Calidad y Auditoría" },
  "Instagram Growth Engine": { es: "Motor de crecimiento de Instagram" },
  "Converta automaticamente comentários de Reels e Posts em DMs e Leads no seu CRM.": {
    es: "Convierte automáticamente comentarios de Reels y publicaciones en mensajes directos y leads en tu CRM.",
  },
  "Novo Gatilho de Comentário": { es: "Nuevo disparador de comentarios" },
  "Gatilhos Ativos": { es: "Disparadores activos" },
  "DMs Disparadas": { es: "Mensajes directos enviados" },
  "Leads Gerados": { es: "Leads generados" },
  "Regras de Automação de Comentários": { es: "Reglas de automatización de comentarios" },
  cadastradas: { es: "registradas" },
  "Carregando gatilhos...": { es: "Cargando disparadores..." },
  "Nenhum gatilho de Instagram ativo": { es: "No hay disparadores de Instagram activos" },
  'Crie seu primeiro gatilho para responder comentários como "EU QUERO" ou "PREÇO" enviando uma DM instantânea com seu link.':
    {
      es: 'Crea tu primer disparador para responder comentarios como "LO QUIERO" o "PRECIO" enviando un mensaje directo instantáneo con tu enlace.',
    },
  "Criar Primeiro Gatilho": { es: "Crear primer disparador" },
  "Palavras-chave:": { es: "Palabras clave:" },
  "Automação nativa": { es: "Automatización nativa" },
  "Criar Gatilho de Comentário (Instagram)": { es: "Crear disparador de comentarios (Instagram)" },
  "Nome da Regra": { es: "Nombre de la regla" },
  "Ex: Campanha Reels - Curso IA": { es: "Ej.: Campaña Reels - Curso IA" },
  "Palavras-chave Gatilho (separadas por vírgula)": {
    es: "Palabras clave del disparador (separadas por comas)",
  },
  "EU QUERO, PREÇO, AULA, ME MANDA": { es: "LO QUIERO, PRECIO, CLASE, ENVÍAME" },
  "Mensagem enviada na DM": { es: "Mensaje enviado por mensaje directo" },
  "Criar Lead automaticamente no Funil de Vendas ao enviar a DM": {
    es: "Crear un lead automáticamente en el embudo de ventas al enviar el mensaje directo",
  },
  "Salvar e Ativar Gatilho": { es: "Guardar y activar disparador" },
  "Inteligência do áudio": { es: "Inteligencia del audio" },
  "Áudio analisado por IA": { es: "Audio analizado por IA" },
  "Ocultar texto": { es: "Ocultar texto" },
  "Ver transcrição": { es: "Ver transcripción" },
  "Preparando transcrição…": { es: "Preparando transcripción…" },
  "Não foi possível transcrever este áudio.": { es: "No se pudo transcribir este audio." },
  "Transcrição ainda não disponível.": { es: "La transcripción aún no está disponible." },
  "Transcrição (IA)": { es: "Transcripción (IA)" },
  "Copiar transcrição": { es: "Copiar transcripción" },
  "Resumo:": { es: "Resumen:" },
  "A ponte de áudio da IA caiu": { es: "Se interrumpió el puente de audio de la IA" },
  "Funcionário de IA": { es: "Empleado de IA" },
  "está conduzindo": { es: "está conduciendo" },
  "O funcionário de IA conversa por voz usando o número conectado ao WaCalls.": {
    es: "El empleado de IA conversa por voz usando el número conectado a WaCalls.",
  },
  "Ligar com IA": { es: "Llamar con IA" },
  "Pedir ligação à IA": { es: "Pedir una llamada a la IA" },
  "O que essa ligação precisa resolver?": { es: "¿Qué debe resolver esta llamada?" },
  "O assistente de voz já está pronto. Conte o objetivo; ele usa o contexto deste atendimento.": {
    es: "El asistente de voz ya está listo. Indica el objetivo; utilizará el contexto de esta atención.",
  },
  "Não foi possível concluir. Tente novamente.": {
    es: "No se pudo completar. Inténtalo de nuevo.",
  },
  "Carregando o atendimento…": { es: "Cargando la atención…" },
  "Não foi possível carregar a ligação.": { es: "No se pudo cargar la llamada." },
  "Cliente deste atendimento": { es: "Cliente de esta atención" },
  "A IA chama a pessoa pelo nome e retoma o assunto deste atendimento, sem pedir que ela explique tudo de novo.":
    {
      es: "La IA llama a la persona por su nombre y retoma el tema de esta atención sin pedirle que lo explique todo de nuevo.",
    },
  "Ligação em andamento": { es: "Llamada en curso" },
  "Você pode fechar este painel. A ligação continua no servidor.": {
    es: "Puedes cerrar este panel. La llamada continúa en el servidor.",
  },
  "Encerramento solicitado": { es: "Finalización solicitada" },
  "Encerrar ligação": { es: "Finalizar llamada" },
  "Sugestões para esta conversa": { es: "Sugerencias para esta conversación" },
  "A partir da última mensagem do cliente": { es: "A partir del último mensaje del cliente" },
  "Seu objetivo está abaixo. Você pode ajustar antes de ligar.": {
    es: "Tu objetivo aparece abajo. Puedes ajustarlo antes de llamar.",
  },
  "Seu objetivo": { es: "Tu objetivo" },
  "Ligue para entender a objeção à proposta e combinar um próximo passo.": {
    es: "Llama para entender la objeción a la propuesta y acordar un próximo paso.",
  },
  "Teste com": { es: "Prueba con" },
  "Ligação para": { es: "Llamada a" },
  "contato a escolher": { es: "contacto por elegir" },
  "Até 5 minutos. Usa o saldo de IA da empresa. Salvar não inicia a chamada.": {
    es: "Hasta 5 minutos. Usa el saldo de IA de la empresa. Guardar no inicia la llamada.",
  },
  "Conectar chamadas": { es: "Conectar llamadas" },
  "Seu WhatsApp de mensagens não conecta as chamadas automaticamente. Conecte o número uma vez pelo QR Code.":
    {
      es: "Tu WhatsApp de mensajes no conecta las llamadas automáticamente. Conecta el número una vez mediante el código QR.",
    },
  "Ative as chamadas da empresa e conecte o número uma vez pelo QR Code.": {
    es: "Activa las llamadas de la empresa y conecta el número una vez mediante el código QR.",
  },
  ...
  "Número que fará a ligação": { es: "Número que realizará la llamada" },
  "Escolher depois": { es: "Elegir después" },
  "Você pode salvar agora e": { es: "Puedes guardar ahora y" },
  "conectar um número em Conexões": { es: "conectar un número en Conexiones" },
  "depois.": { es: "después." },
  "Fazer um teste primeiro": { es: "Hacer una prueba primero" },
  "Usa o contexto deste atendimento, mas liga para o contato de teste escolhido.": {
    es: "Usa el contexto de esta atención, pero llama al contacto de prueba elegido.",
  },
  "Contato autorizado para o teste": { es: "Contacto autorizado para la prueba" },
  "Escolha alguém autorizado a receber a ligação e conhecer o contexto deste atendimento.": {
    es: "Elige a alguien autorizado para recibir la llamada y conocer el contexto de esta atención.",
  },
  "A ligação será para": { es: "La llamada será para" },
  "Conte o que a IA precisa resolver nesta ligação.": {
    es: "Indica qué debe resolver la IA en esta llamada.",
  },
  "Escolha nos ajustes o número de saída ou o contato de teste.": {
    es: "Elige en los ajustes el número de salida o el contacto de prueba.",
  },
  "Ligar para contato de teste": { es: "Llamar al contacto de prueba" },
  "Ligar agora": { es: "Llamar ahora" },
  "Salvar para depois": { es: "Guardar para después" },
  "Pedido salvo. Nenhuma ligação foi iniciada.": {
    es: "Solicitud guardada. No se inició ninguna llamada.",
  },
  "Próximo passo:": { es: "Próximo paso:" },
  "Ver conversa da ligação": { es: "Ver conversación de la llamada" },

  "Qualidade de atendimento": { es: "Calidad de atención" },
  "Crie a persona, escolha o número que será auditado, dispare o teste e acompanhe cada execução.":
    {
      es: "Crea la persona, elige el número que se auditará, inicia la prueba y acompaña cada ejecución.",
    },
  "Novo cenário": { es: "Nuevo escenario" },
  "Cenários ativos": { es: "Escenarios activos" },
  "Prontos para executar": { es: "Listos para ejecutar" },
  Execuções: { es: "Ejecuciones" },
  "Nota média": { es: "Puntuación media" },
  "Sem nota": { es: "Sin puntuación" },
  "Execute e avalie o primeiro teste": { es: "Ejecuta y evalúa la primera prueba" },
  "de 10 pontos": { es: "de 10 puntos" },
  "Primeira resposta": { es: "Primera respuesta" },
  "Sem dados": { es: "Sin datos" },
  "média das concluídas": { es: "promedio de las finalizadas" },
  "Cenários de auditoria": { es: "Escenarios de auditoría" },
  "Toda configuração e o histórico operacional em um só lugar.": {
    es: "Toda la configuración y el historial operativo en un solo lugar.",
  },
  "Buscar cenário": { es: "Buscar escenario" },
  "Só ativos": { es: "Solo activos" },
  "Nenhum cenário configurado": { es: "No hay escenarios configurados" },
  "Defina quem o cliente simulado será, qual número receberá a abordagem e o que deve ser avaliado.":
    {
      es: "Define quién será el cliente simulado, qué número recibirá el contacto y qué se evaluará.",
    },
  "Criar primeiro cenário": { es: "Crear primer escenario" },
  "Última:": { es: "Última:" },
  "Persona:": { es: "Persona:" },
  Destino: { es: "Destino" },
  ...
  execução: { es: "ejecución" },
  execuções: { es: "ejecuciones" },
  "Cenário ativo": { es: "Escenario activo" },
  "Cenário pausado": { es: "Escenario pausado" },
  "Auditar agora": { es: "Auditar ahora" },
  "Complete a configuração": { es: "Completa la configuración" },
  "Configuração operacional": { es: "Configuración operativa" },
  "Editar cenário": { es: "Editar escenario" },
  "Novo cenário de cliente oculto": { es: "Nuevo escenario de cliente misterioso" },
  "Esses dados controlam quem fala, por onde sai e o que será medido.": {
    es: "Estos datos controlan quién habla, por dónde sale y qué se medirá.",
  },
  "1. Cenário e persona": { es: "1. Escenario y persona" },
  "Nome do cenário": { es: "Nombre del escenario" },
  "Objeção de preço no WhatsApp": { es: "Objeción de precio en WhatsApp" },
  "Nome da persona": { es: "Nombre de la persona" },
  "Número que será auditado": { es: "Número que se auditará" },
  "Comportamento da persona": { es: "Comportamiento de la persona" },
  "2. Canal e abordagem": { es: "2. Canal y enfoque" },
  "Canal de saída": { es: "Canal de salida" },
  "Selecione um número conectado": { es: "Selecciona un número conectado" },
  "Nenhum canal WhatsApp conectado e operacional.": {
    es: "No hay ningún canal de WhatsApp conectado y operativo.",
  },
  "Primeira mensagem enviada ao atendimento": { es: "Primer mensaje enviado a la atención" },
  "Olá! Gostaria de entender melhor...": { es: "¡Hola! Me gustaría entenderlo mejor..." },
  "A mensagem sai de verdade ao clicar em Auditar agora.": {
    es: "El mensaje se envía realmente al pulsar Auditar ahora.",
  },
  "Objetivo interno da avaliação": { es: "Objetivo interno de la evaluación" },
  "3. Critérios avaliados": { es: "3. Criterios evaluados" },
  Velocidade: { es: "Velocidad" },
  "Tempo até a primeira resposta": { es: "Tiempo hasta la primera respuesta" },
  Cordialidade: { es: "Cordialidad" },
  "Clareza, educação e empatia": { es: "Claridad, educación y empatía" },
  Objeções: { es: "Objeciones" },
  "Como dúvidas e resistência são conduzidas": {
    es: "Cómo se gestionan las dudas y la resistencia",
  },
  Fechamento: { es: "Cierre" },
  "Próximo passo e chamada para ação": { es: "Próximo paso y llamada a la acción" },
  "Deixar ativo ao salvar": { es: "Dejar activo al guardar" },
  "Criar cenário": { es: "Crear escenario" },
  Comercial: { es: "Comercial" },
  Relacionamento: { es: "Relación con clientes" },
  Operações: { es: "Operaciones" },
  "Qualificação de entrada": { es: "Calificación inicial" },
  "Recebe interessados, entende o cenário e separa oportunidade real de curiosidade.": {
    es: "Recibe interesados, entiende el contexto y separa oportunidades reales de simples consultas.",
  },
  "Qualificar cada contato e entregar ao Closer um contexto pronto para avançar.": {
    es: "Calificar cada contacto y entregar al Closer un contexto listo para avanzar.",
  },
  "Prospecção ativa": { es: "Prospección activa" },
  "Abre novas conversas, pesquisa contexto e transforma contas frias em oportunidades.": {
    es: "Abre nuevas conversaciones, investiga el contexto y transforma cuentas frías en oportunidades.",
  },
  "Gerar interesse legítimo sem parecer disparo genérico ou insistente.": {
    es: "Generar interés legítimo sin parecer un envío genérico o insistente.",
  },
  "Negociação e fechamento": { es: "Negociación y cierre" },
  "Conduz diagnóstico, resolve objeções e organiza a decisão de compra.": {
    es: "Conduce el diagnóstico, resuelve objeciones y organiza la decisión de compra.",
  },
  "Transformar oportunidade qualificada em decisão clara, sem pressão artificial.": {
    es: "Transformar una oportunidad calificada en una decisión clara, sin presión artificial.",
  },
  "Suporte e acolhimento": { es: "Soporte y atención" },
  "Resolve dúvidas, organiza solicitações e mantém o cliente informado até a solução.": {
    es: "Resuelve dudas, organiza solicitudes y mantiene al cliente informado hasta la solución.",
  },
  "Não deixar nenhuma solicitação sem resposta, responsável ou próximo passo.": {
    es: "No dejar ninguna solicitud sin respuesta, responsable o próximo paso.",
  },
  "Cobrança e pagamentos": { es: "Cobros y pagos" },
  "Cuida de dúvidas financeiras, cobranças e encaminhamento de comprovantes.": {
    es: "Atiende dudas financieras, cobros y envío de comprobantes.",
  },
  "Dar clareza financeira sem expor dados, inventar valores ou assumir autoridade indevida.": {
    es: "Dar claridad financiera sin exponer datos, inventar importes ni asumir autoridad indebida.",
  },
  "Rotinas internas": { es: "Rutinas internas" },
  "Organiza cadastros, documentos, solicitações e pendências operacionais.": {
    es: "Organiza registros, documentos, solicitudes y pendientes operativos.",
  },
  "Transformar pedidos soltos em tarefas claras, rastreáveis e com destino correto.": {
    es: "Transformar solicitudes sueltas en tareas claras, rastreables y con el destino correcto.",
  },
  "Pronto para você completar": { es: "Listo para que lo completes" },
  "Aguardando início": { es: "Esperando inicio" },
  "Preparando a ligação": { es: "Preparando la llamada" },
  "Iniciando ligação": { es: "Iniciando llamada" },
  Chamando: { es: "Llamando" },
  "IA conversando": { es: "IA conversando" },
  "Preparando resultado": { es: "Preparando resultado" },
  "Ligação encerrada": { es: "Llamada finalizada" },
  "Não atendeu": { es: "No respondió" },
