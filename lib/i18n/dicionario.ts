...
export const DICIONARIO: Traducoes = {
  "Gerar QR Code": { es: "Generar código QR" },
  "Não foi possível conferir os proxies. A conexão permanece bloqueada até a verificação.": { es: "No se pudieron verificar los proxies. La conexión permanece bloqueada hasta la verificación." },
  "Escolha o país. Um proxy livre será selecionado automaticamente.": { es: "Elige el país. Se seleccionará automáticamente un proxy libre." },
  "País do proxy": { es: "País del proxy" },
  "Selecione o país": { es: "Selecciona el país" },
  "Proxy da conexão": { es: "Proxy de la conexión" },
  "Selecione o proxy": { es: "Selecciona el proxy" },
  "Em uso": { es: "En uso" },
  "Não há proxy disponível neste país. Escolha outro país ou tente novamente mais tarde.": { es: "No hay ningún proxy disponible en este país. Elige otro país o inténtalo más tarde." },
  "O proxy será mantido nas próximas reconexões.": { es: "El proxy se mantendrá en las próximas reconexiones." },
  "Aplicar proxy e reconectar": { es: "Aplicar proxy y reconectar" },
  "Configurar proxy": { es: "Configurar proxy" },
  "Nenhum registro encontrado.": { es: "No se encontraron registros." },
  "Consultar": { es: "Consultar" },
  "Paginação": { es: "Paginación" },
  "Arquivo": { es: "Archivo" },
  "Histórico importado": { es: "Historial importado" },
  "Acesso restrito a gestores.": { es: "Acceso restringido a responsables." },
  "Não foi possível carregar o histórico importado.": { es: "No se pudo cargar el historial importado." },
  "Nenhuma importação registrada nesta empresa.": { es: "No hay importaciones registradas en esta empresa." },
  "Consulte os registros preservados da origem e abra os cadastros vinculados no CRM.": { es: "Consulta los registros conservados del origen y abre las fichas vinculadas en el CRM." },
  "Data de corte": { es: "Fecha de corte" },
  "Tipo de registro": { es: "Tipo de registro" },
  "Outros registros": { es: "Otros registros" },
  "registros": { es: "registros" },
  "Registro de origem": { es: "Registro de origen" },
  "ID de origem": { es: "ID de origen" },
  "Abrir no CRM": { es: "Abrir en el CRM" },
  "Dados preservados da origem": { es: "Datos conservados del origen" },
  "Abrir arquivo": { es: "Abrir archivo" },
  "Anexo indisponível na origem.": { es: "Adjunto no disponible en el origen." },
  "Arquivo inválido.": { es: "Archivo inválido." },
  "Não foi possível carregar o arquivo.": { es: "No se pudo cargar el archivo." },
  "Anexos da mensagem": { es: "Adjuntos del mensaje" },
  "Status de envio não informado na origem.": { es: "Estado de envío no informado en el origen." },
  "Canal histórico — disponível apenas para consulta.": { es: "Canal histórico: disponible solo para consulta." },
  "Perfis de origem": { es: "Perfiles de origen" },
  "Membros de origem": { es: "Miembros de origen" },
  "Identidades dos contatos": { es: "Identidades de los contactos" },
  "Evidências legais": { es: "Evidencias legales" },
  "Canais de origem": { es: "Canales de origen" },
  "Etiquetas das conversas": { es: "Etiquetas de las conversaciones" },
  "Eventos dos canais": { es: "Eventos de los canales" },
  "Memória de IA": { es: "Memoria de IA" },
  "Análises de IA": { es: "Análisis de IA" },
  "Alertas de IA": { es: "Alertas de IA" },
  "Resumos de IA": { es: "Resúmenes de IA" },
  "Mensagens com a IA": { es: "Mensajes con la IA" },
  "Conversas com a IA": { es: "Conversaciones con la IA" },
  "Histórico de responsáveis": { es: "Historial de responsables" },
  "Histórico de estados das conversas": { es: "Historial de estados de las conversaciones" },
  "Participantes das conversas": { es: "Participantes de las conversaciones" },
  "Histórico de etapas": { es: "Historial de etapas" },
  "Traduções das mensagens": { es: "Traducciones de los mensajes" },
  "Histórico de mesclagens": { es: "Historial de unificaciones" },
  "Informações complementares": { es: "Información complementaria" },
  "Histórico da agenda": { es: "Historial de la agenda" },
  "Previsões de comparecimento": { es: "Previsiones de asistencia" },
  "Sinais de risco": { es: "Señales de riesgo" },
  "Previsões de receita": { es: "Previsiones de ingresos" },
  "Objeções": { es: "Objeciones" },
  "Sugestões de duplicidade": { es: "Sugerencias de duplicados" },
  "Papéis de origem": { es: "Roles de origen" },
  "Permissões de origem": { es: "Permisos de origen" },
  "Auditoria de acesso": { es: "Auditoría de acceso" },
  "Restrições de canais": { es: "Restricciones de canales" },
  "Convites de origem": { es: "Invitaciones de origen" },
  "Plano de origem": { es: "Plan de origen" },
  "Sessões de origem": { es: "Sesiones de origen" },
  "Histórico das conexões": { es: "Historial de las conexiones" },
  "Histórico de acompanhamentos": { es: "Historial de seguimientos" },
  "Empresa de origem": { es: "Empresa de origen" },
  "Configuração do plano": { es: "Configuración del plan" },
  "Conversas internas": { es: "Conversaciones internas" },
  "Participantes internos": { es: "Participantes internos" },
  "Notificações de origem": { es: "Notificaciones de origen" },
  "Registros de integração sem credenciais": { es: "Registros de integración sin credenciales" },
  "Auditoria de integrações": { es: "Auditoría de integraciones" },
  "Auditoria administrativa": { es: "Auditoría administrativa" },
  "Aguarde uma nova mensagem do cliente para responder.": { es: "Espera un nuevo mensaje del cliente para responder." },
  "aguarde o cliente": { es: "espera al cliente" },
  "Tempo restante para responder. Depois disso, aguarde uma nova mensagem do cliente.": { es: "Tiempo restante para responder. Después, espera un nuevo mensaje del cliente." },
  "Teste solicitado. Aguarde a confirmação de recebimento nesta tela.": { es: "Prueba solicitada. Espera la confirmación de recepción en esta pantalla." },
  "Configuração atualizada.": { es: "Configuración actualizada." },
  "Não foi possível concluir.": { es: "No se pudo completar." },
  "Não foi possível carregar as conexões sociais.": { es: "No se pudieron cargar las conexiones sociales." },
  "Instagram e Facebook Messenger": { es: "Instagram y Facebook Messenger" },
  "Mensagens diretas no inbox, com atendimento humano e IA.": { es: "Mensajes directos en la bandeja, con atención humana e IA." },
  "Chave de subconta": { es: "Clave de subcuenta" },
  "Chave cadastrada — preencha para substituir": { es: "Clave guardada — completa para reemplazarla" },
  "Cole a chave fornecida para esta empresa": { es: "Pega la clave proporcionada para esta empresa" },
  "Use uma subconta exclusiva desta empresa. A chave fica cifrada no servidor.": { es: "Usa una subcuenta exclusiva de esta empresa. La clave se guarda cifrada en el servidor." },
  "Validar e salvar chave": { es: "Validar y guardar clave" },
  "Recebimento configurado": { es: "Recepción configurada" },
  "Ative o recebimento em um endereço HTTPS público antes de conectar suas contas.": { es: "Activa la recepción en una dirección HTTPS pública antes de conectar tus cuentas." },
  "Configurar recebimento": { es: "Configurar recepción" },
  "Testar recebimento": { es: "Probar recepción" },
  "Atualizar conexões": { es: "Actualizar conexiones" },
  "Último evento recebido:": { es: "Último evento recibido:" },
  "Nenhum evento recebido ainda": { es: "Todavía no se ha recibido ningún evento" },
  "Último teste confirmado:": { es: "Última prueba confirmada:" },
  "Nenhum teste confirmado ainda": { es: "Todavía no se ha confirmado ninguna prueba" },
  "Conectar Instagram": { es: "Conectar Instagram" },
  "Conectar Facebook Messenger": { es: "Conectar Facebook Messenger" },
  "Você será direcionado ao provedor para autorizar a conta e escolher a página.": { es: "Se te dirigirá al proveedor para autorizar la cuenta y elegir la página." },
  "IA liberada neste canal. O agente precisa estar publicado e vinculado à conexão.": { es: "IA habilitada en este canal. El agente debe estar publicado y vinculado a la conexión." },
  "Atendimento humano disponível. A IA está bloqueada neste canal.": { es: "Atención humana disponible. La IA está bloqueada en este canal." },
  "Bloquear IA neste canal": { es: "Bloquear IA en este canal" },
  "Liberar IA neste canal": { es: "Habilitar IA en este canal" },
  "No inbox, use os controles de atendimento para assumir a conversa ou devolvê-la à IA. A janela de resposta fecha 24 horas após a última mensagem do cliente.": { es: "En la bandeja, usa los controles de atención para tomar la conversación o devolverla a la IA. La ventana de respuesta se cierra 24 horas después del último mensaje del cliente." },
  "Instagram e Facebook": { es: "Instagram y Facebook" },
  "Texto livre é recusado pela plataforma. Confira abaixo as opções deste canal.": { es: "La plataforma rechaza el texto libre. Consulta las opciones de este canal a continuación." },
  "Aguarde uma nova mensagem do cliente para responder. Este canal não oferece modelos fora da janela.": { es: "Espera un nuevo mensaje del cliente para responder. Este canal no ofrece plantillas fuera de la ventana." },
  "Recuperar DMs recebidas desde": { es: "Recuperar mensajes directos recibidos desde" },
  "Continuar recuperação": { es: "Continuar recuperación" },
  "Recuperar DMs": { es: "Recuperar mensajes directos" },
  "Mensagens já recebidas não são duplicadas. A recuperação depende da retenção disponível no provedor.": { es: "Los mensajes ya recibidos no se duplican. La recuperación depende de la retención disponible en el proveedor." },
  "Desconectar canal": { es: "Desconectar canal" },
