...
export const DICIONARIO: Traducoes = {
  ...
  "Confira o custo no provedor antes de liberar a reserva. Esta ação não gera cobrança extra.": { es: "Verifica el costo con el proveedor antes de liberar la reserva. Esta acción no genera un cobro adicional." },
  "Atualizar lista": { es: "Actualizar lista" },
  "Ver auditoria": { es: "Ver auditoría" },
  "Carregando consumos…": { es: "Cargando consumos…" },
  "Não foi possível carregar os consumos. Tente atualizar a lista.": { es: "No se pudieron cargar los consumos. Intenta actualizar la lista." },
  "Nenhum consumo em conferência nesta página.": { es: "No hay consumos en revisión en esta página." },
  ...
  "Entrada:": { es: "Entrada:" },
  "Saída:": { es: "Salida:" },
  "O provedor não retornou evidência completa. Não estime o custo pelos horários ou pelo texto da resposta.": { es: "El proveedor no devolvió evidencia completa. No estimes el costo a partir de los horarios o del texto de la respuesta." },
  ...
  "Some todas as etapas desta execução conforme a consulta ao provedor. Use zero somente se a ausência de custo foi comprovada.": { es: "Suma todas las etapas de esta ejecución según la consulta al proveedor. Usa cero solo si se comprobó que no hubo costo." },
  "Custo confirmado no provedor (US$)": { es: "Costo confirmado con el proveedor (US$)" },
  "Tarifa do ciclo:": { es: "Tarifa del ciclo:" },
  "por US$ 1. O desconto respeita o saldo disponível do ciclo original.": { es: "por US$ 1. El descuento respeta el saldo disponible del ciclo original." },
  "Referência da verificação no provedor": { es: "Referencia de la verificación con el proveedor" },
  "Identifique o relatório ou consulta e as chamadas verificadas. Não inclua chaves, mensagens ou dados de clientes.": { es: "Identifica el informe o consulta y las llamadas verificadas. No incluyas claves, mensajes ni datos de clientes." },
  "Conferi todas as chamadas desta execução no provedor e confirmo o valor informado.": { es: "Revisé todas las llamadas de esta ejecución con el proveedor y confirmo el importe indicado." },
  ...
  "A integração precisa ser preparada pela equipe responsável. Depois, você autoriza sua conta na própria rede e escolhe onde receber as mensagens.": { es: "El equipo responsable debe preparar la integración. Después, autorizas tu cuenta en la propia red y eliges dónde recibir los mensajes." },
  ...
  "A IA gerenciada já está disponível. Adicione uma chave própria somente se quiser usar outra conta; agentes existentes mantêm suas configurações.": { es: "La IA gestionada ya está disponible. Añade una clave propia solo si deseas usar otra cuenta; los agentes existentes mantienen sus configuraciones." },
  "Veja quem alterou os dados da empresa, o que mudou e quando.": { es: "Consulta quién modificó los datos de la empresa, qué cambió y cuándo." },
  "Convide sua equipe, defina o acesso de cada pessoa e organize o atendimento.": { es: "Invita a tu equipo, define el acceso de cada persona y organiza la atención." },
  "Mantenha os dados da empresa e defina por quanto tempo guardar as mídias do atendimento.": { es: "Mantén los datos de la empresa y define cuánto tiempo conservar los archivos de la atención." },
  "Crie chaves para conectar outros sistemas. Copie a chave ao criá-la: ela será exibida apenas uma vez.": { es: "Crea claves para conectar otros sistemas. Copia la clave al crearla: solo se mostrará una vez." },
  "Acompanhe os pedidos de acesso e exclusão de dados dos seus clientes.": { es: "Sigue las solicitudes de acceso y eliminación de datos de tus clientes." },
  "Ajuste seu nome, idioma, fuso horário e foto.": { es: "Ajusta tu nombre, idioma, zona horaria y foto." },
  "O e-mail de acesso não pode ser alterado nesta tela.": { es: "El correo de acceso no se puede cambiar en esta pantalla." },
  "Escolha quais avisos receber e por onde quer acompanhar.": { es: "Elige qué avisos recibir y dónde quieres seguirlos." },
  "Traga pedidos, produtos e clientes da sua loja para o CRM.": { es: "Trae pedidos, productos y clientes de tu tienda al CRM." },
  "Cobrança gerenciada pela equipe": { es: "Facturación gestionada por el equipo" },
  "Para consultar seu plano, faturas ou pagamentos, fale com a equipe responsável pelo seu acesso.": { es: "Para consultar tu plan, facturas o pagos, habla con el equipo responsable de tu acceso." },
  "Defina as etapas da venda, os campos de cada oportunidade e os motivos de perda.": { es: "Define las etapas de la venta, los campos de cada oportunidad y los motivos de pérdida." },

  "Abra uma conversa da lista para ver o histórico e responder. Você também pode navegar com J e K.": { es: "Abre una conversación de la lista para ver el historial y responder. También puedes navegar con J y K." },
  "Encontre uma pessoa, consulte seu histórico e acompanhe a relação com seu negócio.": { es: "Encuentra a una persona, consulta su historial y sigue la relación con tu negocio." },
  "Descreva como você atende. Revise, teste e publique quando o agente estiver pronto.": { es: "Describe cómo atiendes. Revisa, prueba y publica cuando el agente esté listo." },
  ...
  "Traga o WhatsApp e o Instagram para o mesmo lugar. A gente te guia na conexão.": { es: "Reúne WhatsApp e Instagram en un mismo lugar. Te guiamos en la conexión." },
  "Conecte seu número e acompanhe as conversas da sua equipe.": { es: "Conecta tu número y sigue las conversaciones de tu equipo." },
  "Veja as opções para receber as mensagens do Instagram no atendimento.": { es: "Consulta las opciones para recibir mensajes de Instagram en la atención." },
  "Ver conexão do Instagram": { es: "Ver conexión de Instagram" },
  "Você escolhe o canal. Nós mostramos o próximo passo.": { es: "Tú eliges el canal. Nosotros te mostramos el siguiente paso." },
  "Atenda com tudo à mão.": { es: "Atiende con todo a mano." },
  "Abra uma conversa, consulte o histórico e acompanhe o próximo contato.": { es: "Abre una conversación, consulta el historial y sigue el próximo contacto." },
  "Uma conversa pode virar uma venda.": { es: "Una conversación puede convertirse en una venta." },
  "Organize as oportunidades no funil e registre o que precisa acontecer depois.": { es: "Organiza las oportunidades en el embudo y registra lo que debe ocurrir después." },
  "Ensine uma vez. Aprimore sempre.": { es: "Enseña una vez. Mejora siempre." },
  "Descreva o atendimento, adicione conhecimento e revise o agente antes de publicar.": { es: "Describe la atención, añade conocimiento y revisa el agente antes de publicarlo." },
  "Escolha o canal, siga a conexão e encontre as mensagens no Inbox.": { es: "Elige el canal, sigue la conexión y encuentra los mensajes en el Inbox." },
  "Entenda o que pede sua atenção.": { es: "Entiende qué necesita tu atención." },
  "Acompanhe os resultados e volte à conversa ou ao funil para agir.": { es: "Sigue los resultados y vuelve a la conversación o al embudo para actuar." },
  "Um espaço que funciona do seu jeito.": { es: "Un espacio que funciona a tu manera." },
  "Organize a equipe, ajuste o atendimento e cuide das permissões do seu negócio.": { es: "Organiza el equipo, ajusta la atención y gestiona los permisos de tu negocio." },
  "Seu espaço está criado.": { es: "Tu espacio está creado." },
  "Você já pode explorar. As configurações abaixo ainda precisam ser concluídas para começar o atendimento.": { es: "Ya puedes explorar. Las configuraciones siguientes aún deben completarse para comenzar la atención." },

  "IA gerenciada pelo escreve.ai. Você não precisa cadastrar uma chave.": { es: "IA gestionada por escreve.ai. No necesitas registrar una clave." },
  "Conte sobre seu negócio, o que o agente deve fazer e quando chamar sua equipe.": { es: "Cuéntanos sobre tu negocio, qué debe hacer el agente y cuándo llamar a tu equipo." },
  "Depois, revise as instruções e escolha onde ele vai atender. Salvar cria um rascunho; publicar libera o atendimento.": { es: "Después, revisa las instrucciones y elige dónde atenderá. Guardar crea un borrador; publicar habilita la atención." },
  "A IA da sua empresa já está configurada para este agente.": { es: "La IA de tu empresa ya está configurada para este agente." },
  "A IA ainda precisa ser preparada pelo administrador. Você pode configurar o agente manualmente enquanto isso.": { es: "El administrador todavía debe preparar la IA. Mientras tanto puedes configurar el agente manualmente." },
  ...
  "Converse com o conteúdo do seu CRM. Encontre informações, entenda suas conversas e acompanhe o funil.": { es: "Conversa con el contenido de tu CRM. Encuentra información, entiende tus conversaciones y sigue el embudo." },
  ...
  "Pergunte sobre uma conversa, uma oportunidade ou um conteúdo…": { es: "Pregunta sobre una conversación, una oportunidad o un contenido…" },
  ...
  "Consulta seus dados com suas permissões. Nenhuma mensagem é enviada aos clientes.": { es: "Consulta tus datos con tus permisos. No se envían mensajes a los clientes." },
  "Continue no seu espaço": { es: "Continúa en tu espacio" },
  "A conexão falhou. Sua pergunta foi mantida; tente novamente.": { es: "La conexión falló. Tu pregunta se ha conservado; inténtalo de nuevo." },
  ...
  "Não foi possível confirmar o salvamento. Suas alterações continuam nesta tela. Tente novamente.": { es: "No se pudo confirmar el guardado. Tus cambios siguen en esta pantalla. Inténtalo de nuevo." },
  "Seu jeito de atender começa aqui. Escreve aí.": { es: "Tu forma de atender empieza aquí. Escribe aquí." },
  ...
  "A resposta não chegou. Sua mensagem foi mantida; tente novamente.": { es: "La respuesta no llegó. Tu mensaje se ha conservado; inténtalo de nuevo." },
  ...
  "Conte como você quer atender. A conversa organiza uma proposta que você pode revisar e ajustar.": { es: "Cuenta cómo quieres atender. La conversación organiza una propuesta que puedes revisar y ajustar." },
  "Conversa de criação": { es: "Conversación de creación" },
  "Pode começar pelo seu negócio, por uma tarefa ou pelo que hoje toma seu tempo. Eu pergunto só o que faltar.": { es: "Puedes empezar por tu negocio, una tarea o lo que hoy te quita tiempo. Solo preguntaré lo que falte." },
  ...
  "Quero um agente que atenda os interessados, explique meus serviços e organize as oportunidades no funil…": { es: "Quiero un agente que atienda a los interesados, explique mis servicios y organice las oportunidades en el embudo…" },
  "Ver configuração da IA": { es: "Ver configuración de IA" },
  "Ctrl/⌘ + Enter para enviar": { es: "Ctrl/⌘ + Enter para enviar" },
  "Esta conversa prepara uma proposta. O agente só é salvo no editor e só atende depois de você publicar.": { es: "Esta conversación prepara una propuesta. El agente solo se guarda en el editor y solo atiende después de publicarlo." },
  ...
  "Marque apenas o que autoriza levar ao rascunho. Nenhuma sugestão é ligada sozinha.": { es: "Marca solo lo que autorizas llevar al borrador. Ninguna sugerencia se activa sola." },
  "Ao revisar, o texto da proposta atualiza nome, descrição e instruções. Suas escolhas de modelo, número, limites e capacidades já configuradas são preservadas.": { es: "Al revisar, el texto de la propuesta actualiza el nombre, la descripción y las instrucciones. Se conservan tus elecciones de modelo, número, límites y capacidades ya configuradas." },
  "Revisar rascunho": { es: "Revisar borrador" },
  "Configure o comportamento dos agentes que respondem no WhatsApp.": { es: "Configura el comportamiento de los agentes que responden en WhatsApp." },
  "Nova conversa": { es: "Nueva conversación" },
  "Seu próximo agente começa com uma ideia.": { es: "Tu próximo agente empieza con una idea." },
  "Conte o que precisa. A gente organiza com você.": { es: "Cuenta qué necesitas. Lo organizamos contigo." },
  ...
  "Quero responder dúvidas sobre meus serviços e chamar minha equipe quando precisar.": { es: "Quiero responder preguntas sobre mis servicios y llamar a mi equipo cuando sea necesario." },
  "Quero entender o interesse dos clientes e organizar as oportunidades no funil.": { es: "Quiero entender el interés de los clientes y organizar las oportunidades en el embudo." },
  "Quero ajudar meus clientes a escolher um horário para serem atendidos.": { es: "Quiero ayudar a mis clientes a elegir un horario para ser atendidos." },
  "Ex.: quero responder dúvidas sobre meus serviços e chamar minha equipe quando precisar.": { es: "Ej.: quiero responder preguntas sobre mis servicios y llamar a mi equipo cuando sea necesario." },
