...
export const DICIONARIO: Traducoes = {
  ...
  "Acompanhar o agente": { es: "Seguir al agente" },
  "A chave do provedor de IA que os agentes usam para pensar.": { es: "La clave del proveedor de IA que usan los agentes para pensar." },
  "As ações que o agente pode executar sozinho durante o atendimento.": { es: "Las acciones que el agente puede ejecutar solo durante la atención." },
  ...
  "Como o agente retoma uma conversa que esfriou, para nenhuma morrer no silêncio.": { es: "Cómo el agente retoma una conversación que se enfrió, para que ninguna muera en silencio." },
  ...
  "Melhorias que a IA sugere para si mesma, esperando sua decisão.": { es: "Mejoras que la IA sugiere para sí misma, esperando tu decisión." },
  ...
  "O que a IA encontrou e precisa de uma decisão sua.": { es: "Lo que la IA encontró y necesita una decisión tuya." },
  "O que a IA fez — e, quando falhou, o que aconteceu e o que fazer.": { es: "Lo que hizo la IA — y, cuando falló, qué pasó y qué hacer." },
  "O que o agente já aprendeu sobre a sua operação e reaproveita.": { es: "Lo que el agente ya aprendió de tu operación y reutiliza." },
  ...
  "Os atendimentos que o agente conduziu, do início ao desfecho.": { es: "Las atenciones que el agente condujo, del inicio al desenlace." },
  "Os materiais que o agente consulta antes de responder sobre o seu negócio.": { es: "Los materiales que el agente consulta antes de responder sobre tu negocio." },
  "Qual agente pega qual conversa, e quando o humano assume.": { es: "Qué agente toma cada conversación, y cuándo asume el humano." },
  "Qual inteligência atende cada parte do sistema — e o que acontece se ela falhar.": { es: "Qué inteligencia atiende cada parte del sistema — y qué pasa si falla." },
  "Quanto a IA consumiu e qual é o teto de gasto do mês.": { es: "Cuánto consumió la IA y cuál es el tope de gasto del mes." },
  ...
  "Quem atende por você: instruções, modelo, ferramentas e publicação.": { es: "Quién atiende por ti: instrucciones, modelo, herramientas y publicación." },
