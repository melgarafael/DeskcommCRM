...
export const DICIONARIO: Traducoes = {
  ...
  // ─── Cadências de e-mail (fork) ───
  "A cadência está": { es: "La cadencia está" },
  "A cadência está no ar. Para editar os passos ou as configurações, pause primeiro.": { es: "La cadencia está activa. Para editar los pasos o la configuración, pausala primero." },
  "A cadência precisa de pelo menos um e-mail.": { es: "La cadencia necesita al menos un correo." },
  "A espera precisa ser de pelo menos 1 dia útil.": { es: "La espera debe ser de al menos 1 día hábil." },
  "A resposta aparece no CRM e a cadência para para esse lead.": { es: "La respuesta aparece en el CRM y la cadencia se detiene para ese lead." },
  "A tarefa vai para o dono do lead. Sem dono, vai para quem administra a cadência.": { es: "La tarea va al responsable del lead. Sin responsable, va a quien administra la cadencia." },
  "ATIVA": { es: "ACTIVA" },
  "Abertos únicos": { es: "Aperturas únicas" },
  "Aberturas": { es: "Aperturas" },
  "Aberturas com menos de 1 hora de intervalo contam como uma só — filtra as aberturas automáticas do Apple Mail e de filtros corporativos.": { es: "Las aperturas con menos de 1 hora de diferencia cuentan como una sola — filtra las aperturas automáticas de Apple Mail y de filtros corporativos." },
  "Abriu o e-mail anterior": { es: "Abrió el correo anterior" },
  "Adicionar passo": { es: "Agregar paso" },
  "Adicionar passo aqui": { es: "Agregar un paso aquí" },
  "Afastar": { es: "Alejar" },
  "Aguardar quantos dias úteis?": { es: "¿Cuántos días hábiles esperar?" },
  "Aproximar": { es: "Acercar" },
  "Assim que a condição acontecer, o lead segue pelo “Sim”. Se o prazo acabar antes, segue pelo “Não”.": { es: "En cuanto se cumpla la condición, el lead sigue por el “Sí”. Si el plazo termina antes, sigue por el “No”." },
  "Bounces": { es: "Rebotes" },
  "Cada e-mail sai da caixa do dono do lead. Escolha a caixa usada quando o lead não tem dono ou o dono ainda não conectou a caixa dele.": { es: "Cada correo sale del buzón del responsable del lead. Elige el buzón que se usa cuando el lead no tiene responsable o este aún no conectó su buzón." },
  "Cada inscrição, e-mail enviado, abertura, resposta e parada vai aparecer aqui, com data e hora.": { es: "Cada inscripción, correo enviado, apertura, respuesta y detención aparecerá aquí, con fecha y hora." },
  "Cadência ativada.": { es: "Cadencia activada." },
  "Cadência não encontrada.": { es: "Cadencia no encontrada." },
  "Cadência pausada. Nenhum e-mail novo sai até você ativar de novo.": { es: "Cadencia pausada. No sale ningún correo nuevo hasta que la actives de nuevo." },
  "Cadências": { es: "Cadencias" },
  "Caixa padrão": { es: "Buzón predeterminado" },
  "Cargo": { es: "Cargo" },
  "Clicou em um link do e-mail anterior": { es: "Hizo clic en un enlace del correo anterior" },
  "Cliques": { es: "Clics" },
  "Criar e montar os passos": { es: "Crear y armar los pasos" },
  "Criar tarefa": { es: "Crear tarea" },
  "Crie uma cadência para cada segmento que você prospecta — por exemplo, papel e celulose.": { es: "Crea una cadencia para cada segmento que prospectas — por ejemplo, papel y celulosa." },
  "DESATIVADA": { es: "DESACTIVADA" },
  "Dias da semana": { es: "Días de la semana" },
  "Disponível a partir do segundo e-mail do caminho.": { es: "Disponible a partir del segundo correo del camino." },
  "Divide o caminho conforme o lead abriu, clicou ou respondeu.": { es: "Divide el camino según si el lead abrió, hizo clic o respondió." },
  "Dê um nome e diga qual segmento ela atende. Os passos você monta em seguida.": { es: "Ponle un nombre e indica a qué segmento atiende. Los pasos los armas a continuación." },
  "Dê um título à tarefa.": { es: "Ponle un título a la tarea." },
  "Editada em": { es: "Editada el" },
  "Em breve": { es: "Próximamente" },
  "Endereço inexistente ou caixa cheia. Protege a reputação do domínio.": { es: "Dirección inexistente o buzón lleno. Protege la reputación del dominio." },
  "Enviar WhatsApp": { es: "Enviar WhatsApp" },
  "Enviar e-mail": { es: "Enviar correo" },
  "Escolha a caixa padrão em Configurações.": { es: "Elige el buzón predeterminado en Configuración." },
  "Escolha a tag do segmento em Configurações": { es: "Elige la etiqueta del segmento en Configuración" },
  "Escolha a tag do segmento em Configurações.": { es: "Elige la etiqueta del segmento en Configuración." },
  "Escolha pelo menos um dia da semana para enviar.": { es: "Elige al menos un día de la semana para enviar." },
  "Escolha uma caixa": { es: "Elige un buzón" },
  "Escreva a mensagem do WhatsApp.": { es: "Escribe el mensaje de WhatsApp." },
  "Escreva o corpo do e-mail.": { es: "Escribe el cuerpo del correo." },
  "Espera alguns dias úteis antes do próximo passo.": { es: "Espera algunos días hábiles antes del siguiente paso." },
  "Esperar a resposta por até (dias úteis)": { es: "Esperar la respuesta hasta (días hábiles)" },
  "Ex.: Ligar para o lead": { es: "Ej.: Llamar al lead" },
  "Ex.: Papel e celulose": { es: "Ej.: Papel y celulosa" },
  "Ex.: Papel e celulose — primeira abordagem": { es: "Ej.: Papel y celulosa — primer contacto" },
  "Ex.: {{primeiro_nome}}, uma ideia para a {{empresa}}": { es: "Ej.: {{primeiro_nome}}, una idea para {{empresa}}" },
  "Excluir cadência": { es: "Eliminar cadencia" },
  "Excluir esta cadência?": { es: "¿Eliminar esta cadencia?" },
  "Excluir passo": { es: "Eliminar paso" },
  "Fim da cadência": { es: "Fin de la cadencia" },
  "Fim deste caminho": { es: "Fin de este camino" },
  "Gatilho de inscrição": { es: "Disparador de inscripción" },
  "Horário de Brasília": { es: "Hora de Brasilia" },
  "Há passos com problema — eles estão marcados em vermelho.": { es: "Hay pasos con problemas — están marcados en rojo." },
  "Informe o assunto do e-mail.": { es: "Indica el asunto del correo." },
  "Inscrição": { es: "Inscripción" },
  "Inserir:": { es: "Insertar:" },
  "Janela de envio": { es: "Ventana de envío" },
  "Lead recebe a tag": { es: "El lead recibe la etiqueta" },
  "Limite de envios por caixa, por dia": { es: "Límite de envíos por buzón, por día" },
  "Mensagem ainda não escrita": { es: "Mensaje aún no escrito" },
  "Mensagem automática no WhatsApp, se o lead tiver telefone.": { es: "Mensaje automático en WhatsApp, si el lead tiene teléfono." },
  "Mensagem para quem nunca falou com o número é o cenário de maior risco de banimento. Sai pelo WhatsApp conectado, respeitando o ritmo, o horário e a lista de quem pediu para sair. Prefira um número secundário.": { es: "Escribir a quien nunca habló con el número es el escenario de mayor riesgo de bloqueo. Sale por el WhatsApp conectado, respetando el ritmo, el horario y la lista de quienes pidieron salir. Prefiere un número secundario." },
  "Mensagem vazia": { es: "Mensaje vacío" },
  "Nenhum lead passou por esta cadência ainda": { es: "Ningún lead pasó por esta cadencia todavía" },
  "Nenhuma cadência ainda": { es: "Todavía no hay cadencias" },
  "Nome da cadência": { es: "Nombre de la cadencia" },
  "Nome do vendedor": { es: "Nombre del vendedor" },
  "Nova cadência": { es: "Nueva cadencia" },
  "Não faz sentido seguir prospectando quem já fechou ou saiu.": { es: "No tiene sentido seguir prospectando a quien ya cerró o se fue." },
  "Não quer mais receber estes e-mails? Descadastrar": { es: "¿No quieres recibir más estos correos? Darse de baja" },
  "O Treg marca o e-mail como validado. Lead sem essa marca não entra, para não queimar o domínio com bounce.": { es: "Treg marca el correo como validado. Un lead sin esa marca no entra, para no dañar el dominio con rebotes." },
  "O desempenho aparece quando os envios começarem": { es: "El rendimiento aparece cuando empiecen los envíos" },
  "O lead que receber esta tag (por exemplo, vindo do Treg pelo webhook de captação) entra na cadência automaticamente.": { es: "El lead que reciba esta etiqueta (por ejemplo, desde Treg por el webhook de captación) entra en la cadencia automáticamente." },
  "O link de descadastro entra automaticamente no fim de todo e-mail.": { es: "El enlace para darse de baja se agrega automáticamente al final de cada correo." },
  "O que passar do limite fica na fila para o próximo dia útil.": { es: "Lo que supere el límite queda en la cola para el siguiente día hábil." },
  "O ramo precisa de pelo menos um passo em um dos lados.": { es: "La rama necesita al menos un paso en uno de los lados." },
  "O vendedor também pode pausar, pular um passo ou tirar o lead da cadência a qualquer momento.": { es: "El vendedor también puede pausar, saltar un paso o sacar al lead de la cadencia en cualquier momento." },
  "Obrigatório pela LGPD: o endereço entra na lista de supressão.": { es: "Obligatorio por la LGPD: la dirección entra en la lista de supresión." },
  "Oi {{primeiro_nome}}, ...": { es: "Hola {{primeiro_nome}}, ..." },
  "PAUSADA": { es: "PAUSADA" },
  "Para antes se o lead": { es: "Se detiene antes si el lead" },
  "Pelo menos quantas vezes?": { es: "¿Al menos cuántas veces?" },
  "Por cadência e por etapa: enviados, abertos únicos, total de aberturas, média por lead, cliques, respostas, bounces e descadastros.": { es: "Por cadencia y por etapa: enviados, aperturas únicas, total de aperturas, promedio por lead, clics, respuestas, rebotes y bajas." },
  "Prazo (dias úteis)": { es: "Plazo (días hábiles)" },
  "Primeiro nome": { es: "Primer nombre" },
  "Prévia com um lead de exemplo": { es: "Vista previa con un lead de ejemplo" },
  "Quando a cadência para": { es: "Cuándo se detiene la cadencia" },
  "Quando o card for para ganho ou perdido": { es: "Cuando la tarjeta pase a ganado o perdido" },
  "Quando o e-mail voltar (bounce)": { es: "Cuando el correo rebote" },
  "Quando o lead responder": { es: "Cuando el lead responda" },
  "Quando o lead se descadastrar": { es: "Cuando el lead se dé de baja" },
  "Ramificação se/então": { es: "Ramificación si/entonces" },
  "Re: assunto do e-mail anterior": { es: "Re: asunto del correo anterior" },
  "Remetente": { es: "Remitente" },
  "Responder na mesma conversa": { es: "Responder en la misma conversación" },
  "Respondeu o e-mail": { es: "Respondió el correo" },
  "Resposta na mesma conversa": { es: "Respuesta en la misma conversación" },
  "Respostas": { es: "Respuestas" },
  "Revisar e ativar": { es: "Revisar y activar" },
  "Sai da caixa do dono do lead. Lead sem dono usa a caixa padrão da cadência.": { es: "Sale del buzón del responsable del lead. Un lead sin responsable usa el buzón predeterminado de la cadencia." },
  "Segmento": { es: "Segmento" },
  "Segmento (tag)": { es: "Segmento (etiqueta)" },
  "Sem assunto": { es: "Sin asunto" },
  "Sem tag de segmento": { es: "Sin etiqueta de segmento" },
  "Sequências de e-mail por segmento, com parada automática quando o lead responde.": { es: "Secuencias de correo por segmento, con detención automática cuando el lead responde." },
  "Sequências de e-mail por segmento: o lead entra pela tag, recebe os e-mails no ritmo certo e sai sozinho quando responde.": { es: "Secuencias de correo por segmento: el lead entra por la etiqueta, recibe los correos al ritmo adecuado y sale solo cuando responde." },
  "Sábados, domingos e feriados não contam. O próximo passo sai dentro da janela de horário da cadência.": { es: "Sábados, domingos y feriados no cuentan. El siguiente paso sale dentro de la ventana horaria de la cadencia." },
  "Só inscrever lead com e-mail validado": { es: "Solo inscribir leads con correo validado" },
  "Só roda se o lead tiver telefone. Sem telefone, o passo é pulado e o lead segue o caminho.": { es: "Solo se ejecuta si el lead tiene teléfono. Sin teléfono, el paso se salta y el lead sigue el camino." },
  "Tag do segmento": { es: "Etiqueta del segmento" },
  "Tag:": { es: "Etiqueta:" },
  "Tamanho original": { es: "Tamaño original" },
  "Também dá para inscrever leads manualmente ou em lote.": { es: "También se pueden inscribir leads manualmente o en lote." },
  "Tarefa sem título": { es: "Tarea sin título" },
  "Título da tarefa": { es: "Título de la tarea" },
  "Um e-mail da caixa do vendedor, com variáveis do lead.": { es: "Un correo desde el buzón del vendedor, con variables del lead." },
  "Uma tarefa para o dono do lead, com prazo.": { es: "Una tarea para el responsable del lead, con plazo." },
  "Use um domínio secundário para prospecção — assim o domínio principal da empresa fica protegido.": { es: "Usa un dominio secundario para prospección — así el dominio principal de la empresa queda protegido." },
  "Vai como resposta ao e-mail anterior (“Re:”), na mesma thread.": { es: "Va como respuesta al correo anterior (“Re:”), en el mismo hilo." },
  ...
  "e tem e-mail validado": { es: "y tiene correo validado" },
  "e-mail": { es: "correo" },
  "e-mails": { es: "correos" },
  "em até": { es: "en hasta" },
  "o card for para ganho ou perdido": { es: "la tarjeta pase a ganado o perdido" },
  "o e-mail voltar": { es: "el correo rebote" },
  "ramificação": { es: "ramificación" },
  "ramificações": { es: "ramificaciones" },
  "responder": { es: "responda" },
  "se descadastrar": { es: "se dé de baja" },
  "vez": { es: "vez" },
  "vezes": { es: "veces" },
};
