...
export const DICIONARIO: Traducoes = {
  "Grade semanal": { es: "Horario semanal" },
  "Nova aula": { es: "Nueva clase" },
  "Editar aula": { es: "Editar clase" },
  "Salvar aula": { es: "Guardar clase" },
  "Aula salva.": { es: "Clase guardada." },
  "Aula ativa": { es: "Clase activa" },
  "Organize as aulas por dia. Aulas no mesmo horário são permitidas.": { es: "Organiza las clases por día. Se permiten clases simultáneas." },
  "Esta é a grade semanal de referência. Cancelamentos por data, feriados e consultas pela IA serão tratados nas próximas etapas.": { es: "Este es el horario semanal de referencia. Las cancelaciones por fecha, los feriados y las consultas de IA se incorporarán en las próximas etapas." },
  "Administradores e gestores podem editar a grade.": { es: "Los administradores y gestores pueden editar el horario." },
  "Antes de criar aulas, adicione cadastros ativos em Cadastros": { es: "Antes de crear clases, añade registros activos en Registros" },
  "Não foi possível atualizar a grade. Os dados exibidos podem estar desatualizados.": { es: "No se pudo actualizar el horario. Los datos mostrados pueden estar desactualizados." },
  "Carregando grade…": { es: "Cargando horario…" },
  "Todos os dias": { es: "Todos los días" },
  "Mostrar aulas inativas": { es: "Mostrar clases inactivas" },
  "Atualizar grade": { es: "Actualizar horario" },
  "Nenhuma aula para exibir. Cadastre uma aula ou ajuste os filtros.": { es: "No hay clases para mostrar. Crea una clase o ajusta los filtros." },
  "Modalidade indisponível": { es: "Actividad no disponible" },
  "Indisponível": { es: "No disponible" },
  "Cadastro inativo": { es: "Registro inactivo" },
  "Modalidade inativa. Revise os vínculos desta aula.": { es: "Actividad inactiva. Revisa los registros vinculados a esta clase." },
  "Última alteração": { es: "Última modificación" },
  "Não foi possível confirmar a gravação. Tente salvar novamente para conferir, sem duplicar a aula.": { es: "No se pudo confirmar el guardado. Intenta guardar de nuevo para comprobarlo, sin duplicar la clase." },
  "Defina os vínculos e o horário semanal. Professor e ambiente são informações separadas.": { es: "Define los registros vinculados y el horario semanal. El profesor y el espacio son datos separados." },
  "Selecione": { es: "Selecciona" },
  "Desativar retira a aula da grade ativa e preserva o registro. A edição altera a referência semanal inteira.": { es: "Desactivar retira la clase del horario activo y conserva el registro. La edición modifica toda la referencia semanal." },
  "Áreas da academia": { es: "Áreas del gimnasio" },
  "Organize a grade de aulas e os cadastros da sua academia.": { es: "Organiza el horario de clases y los registros de tu gimnasio." },
  "Professor": { es: "Profesor" },
  "Ambiente": { es: "Espacio" },
  "Modalidade": { es: "Actividad" },
  "+1 dia": { es: "+1 día" },
  "Não foi possível salvar a aula.": { es: "No se pudo guardar la clase." },
  "Esta aula mudou ou não está disponível. Atualize a grade antes de editar novamente.": { es: "Esta clase cambió o no está disponible. Actualiza el horario antes de editar de nuevo." },
  "Confira os campos e selecione cadastros ativos desta empresa para os vínculos novos ou para reativar a aula.": { es: "Revisa los campos y selecciona registros activos de esta empresa para los nuevos vínculos o para reactivar la clase." },
  "Este identificador já foi usado para outra aula. Atualize a grade antes de tentar novamente.": { es: "Este identificador ya se usó para otra clase. Actualiza el horario antes de volver a intentarlo." },
  "Você não tem permissão para salvar esta aula.": { es: "No tienes permiso para guardar esta clase." },
  "Observações": { es: "Observaciones" },
  "Cadastros da academia": { es: "Registros del gimnasio" },
  "Tipo de cadastro": { es: "Tipo de registro" },
  "Públicos": { es: "Públicos" },
  "Modalidades": { es: "Modalidades" },
  "Professores": { es: "Profesores" },
  "Ambientes": { es: "Espacios" },
  "Novo cadastro": { es: "Nuevo registro" },
  "As faixas etárias podem ser ajustadas. Marque como provisória toda regra que ainda precisa de confirmação.": { es: "Los rangos de edad se pueden ajustar. Marca como provisional cualquier regla pendiente de confirmación." },
  "Administradores e gestores podem editar estes cadastros.": { es: "Los administradores y gestores pueden editar estos registros." },
  "Carregando cadastros…": { es: "Cargando registros…" },
  "Não foi possível atualizar a lista. Os dados exibidos podem estar desatualizados.": { es: "No se pudo actualizar la lista. Los datos mostrados pueden estar desactualizados." },
  "Nenhum cadastro por aqui ainda.": { es: "Todavía no hay registros aquí." },
  "Os registros cadastrados aqui serão usados na grade de aulas.": { es: "Estos registros se utilizarán en el horario de clases." },
  "Idade mínima": { es: "Edad mínima" },
  "Idade máxima": { es: "Edad máxima" },
  "Não definida": { es: "No definida" },
  "Faixa etária provisória": { es: "Rango de edad provisional" },
  "Faixa etária confirmada": { es: "Rango de edad confirmado" },
  "Nomes alternativos": { es: "Nombres alternativos" },
  "Cadastro salvo.": { es: "Registro guardado." },
  "Não foi possível salvar o cadastro.": { es: "No se pudo guardar el registro." },
  "Não foi possível confirmar a gravação. Tente salvar novamente para conferir, sem duplicar o cadastro.": { es: "No se pudo confirmar el guardado. Vuelve a guardar para comprobarlo sin duplicar el registro." },
  "Editar cadastro": { es: "Editar registro" },
  "Campo vazio significa informação não definida. As idades são informadas em anos completos.": { es: "Un campo vacío significa información no definida. Las edades se expresan en años cumplidos." },
  "Separe por vírgulas. Exemplo: spinning, bike indoor.": { es: "Separa los nombres con comas. Ejemplo: spinning, bike indoor." },
  "Cadastro ativo": { es: "Registro activo" },
  "Desativar preserva o cadastro e seu histórico.": { es: "Desactivar conserva el registro y su historial." },
  "Salvar cadastro": { es: "Guardar registro" },
  "Organize os públicos, modalidades, professores e ambientes da sua academia.": { es: "Organiza los públicos, modalidades, profesores y espacios de tu gimnasio." },
  "A idade mínima deve ser menor ou igual à máxima.": { es: "La edad mínima debe ser menor o igual que la máxima." },
  "Use nomes alternativos diferentes entre si e do nome principal.": { es: "Usa nombres alternativos distintos entre sí y del nombre principal." },
  "Já existe um cadastro com esse nome ou identificador. Confira a lista antes de tentar novamente.": { es: "Ya existe un registro con ese nombre o identificador. Revisa la lista antes de volver a intentarlo." },
  "Este cadastro mudou ou não está disponível. Atualize a lista antes de editar novamente.": { es: "Este registro cambió o no está disponible. Actualiza la lista antes de volver a editarlo." },
