  ...
  public: {
    Tables: {
      ...
      channel_proxy_bindings: {
        ...
        Relationships: [
          {
            foreignKeyName: "channel_proxy_bindings_organization_id_channel_session_id_fkey"
            columns: ["organization_id", "channel_session_id"]
            isOneToOne: false
            referencedRelation: "channel_sessions"
            referencedColumns: ["organization_id", "id"]
          ...
          {
            foreignKeyName: "channel_proxy_bindings_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
      ...
      channel_sessions: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "channel_sessions_social_connection_id_fkey"
          ...
          {
            foreignKeyName: "channel_sessions_social_tenant_fk"
      ...
      crm_tasks: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "crm_tasks_conversation_tenant_fk"
      ...
      data_import_record_contacts: {
        ...
        Relationships: [
          {
            foreignKeyName: "data_import_record_contacts_organization_id_contact_id_fkey"
          ...
          {
            foreignKeyName: "data_import_record_contacts_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "data_import_record_contacts_organization_id_record_id_fkey"
      ...
      data_import_records: {
        ...
        Relationships: [
          {
            foreignKeyName: "data_import_records_contact_id_fkey"
            columns: ["contact_id"]
            isOneToOne: false
            referencedRelation: "contacts"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "data_import_records_contact_tenant_fk"
            columns: ["organization_id", "contact_id"]
            isOneToOne: false
            referencedRelation: "contacts"
            referencedColumns: ["organization_id", "id"]
          ...
          {
            foreignKeyName: "data_import_records_conversation_id_fkey"
            columns: ["conversation_id"]
            isOneToOne: false
            referencedRelation: "conversations"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "data_import_records_conversation_tenant_fk"
            columns: ["organization_id", "conversation_id"]
            isOneToOne: false
            referencedRelation: "conversations"
            referencedColumns: ["organization_id", "id"]
          ...
          {
            foreignKeyName: "data_import_records_organization_id_batch_id_fkey"
      ...
      message_attachments: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "message_attachments_organization_id_message_id_fkey"
      ...
      social_connections: {
        Row: {
          ...
          webhook_secret: Json | null
          webhook_setup_token: string | null
          webhook_setup_until: string | null
      ...
      social_webhook_receipts: {
        ...
        Relationships: [
          {
            foreignKeyName: "social_webhook_receipts_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      fn_historical_import_allowed: {
        Args: { p_org: string }
        Returns: boolean
      }
      fn_ingest_social_dm: {
        Args: { p_message: Json; p_org: string; p_session: string }
        Returns: Json
      }
