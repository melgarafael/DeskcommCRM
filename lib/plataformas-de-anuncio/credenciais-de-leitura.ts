 ...
 * pelas quatro razões no cabeçalho da migration 0205 — a primeira delas sendo
 * que o índice único da 0204 é `(organization_id, platform)` e os dois tokens
 ...
 * policies, com grants revogados de anon/authenticated (0205). Pelo client de
