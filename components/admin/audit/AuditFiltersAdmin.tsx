        ...
        <div className="space-y-1">
          ...
          {selected.length > 0 && (
            <button
              ...
              className="w-full rounded-full px-2 py-1 text-left text-xs text-muted-foreground hover:bg-accent"
            >
          ...
          <div className="max-h-52 overflow-y-auto space-y-0.5">
            ...
            {filtered.map((o) => (
              <button
                ...
                className={`w-full rounded-full px-2 py-1.5 text-left text-sm transition-colors ${
