-- 0170 — LOCALE PADRÃO PASSA DE pt-BR PARA pt-PT.
--
-- Mesma lógica da 0168 (fuso padrão): esta instalação opera em Moçambique
...
-- instalação, mesma cautela da 0168 com o fuso). `alter column ... set
